...

{
    ...
    introText:
      "Most 529 college savings plans give you two investment options: an age-based portfolio that automatically shifts from stocks to bonds as your child gets closer to college, or a static portfolio with a fixed allocation that you manage yourself. The right choice depends mostly on how hands-on you want to be and how many years remain before enrollment. This guide compares the two, provides examples of age-based allocations, and explains a federal rule that limits how often you can change your investment choice.",
    sections: [
