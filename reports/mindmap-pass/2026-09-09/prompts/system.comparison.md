# WRITER SYSTEM — comparison pages for ModernWallet (themodernwallet.com)
...
```json
{
  ...
  introText:
    "SoFi Invest is part of SoFi's all-in-one banking and investing app. Robinhood, by contrast, is built around one job: fast, simple stock and options trading.\n\n[SoFi](https://www.sofi.com) rewards you for using more of its products together through its SoFi Plus membership tier. [Robinhood](https://robinhood.com) rewards you for trading more on its one product through Robinhood Gold. Since both charge $0 commission, the right fit depends less on fees and more on what you want: one app to run your whole financial life, or one built purely around trading.",
  comparisonTable: {
    rows: [
...
## OUTPUT CONTRACT — return ONE JSON object, these keys EXACTLY (this repo's ComparisonEntry shape)
{
  "slug": "<exact slug>",
  "title": "<<=60 chars, both entities named, Title Case>",
  "metaDescription": "<<=160 chars>",
  "targetKeyword": "<primary keyword>",
  "optionA": "<entity A display name>",
  "optionB": "<entity B display name>",
  "h1": "<H1, Title Case>",
  "introText": "<2-3 paragraphs, \n\n between. Sentence 1 = a self-contained answer to which/when. Operator register.>",
  "comparisonTable": { "rows": [ { "dimension": "<criterion>", "a": "<A value>", "b": "<B value>" } ] },
  "verdict": "<a committed recommendation: who should pick A, who should pick B, and what would change it>",
  "sections": [ { "heading": "<Title Case>", "content": "<prose>" } ],
  "faqs": [ { "question": "...", "answer": "..." } ],
  "sources": [ { "label": "...", "url": "..." } ]
}
Return ONLY the JSON object. 5-8 table rows, 4-7 sections, 5-8 FAQs.
