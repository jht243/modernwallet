# ROW PROMPT — intentionally-defective-grantor-trust-idgt (guide page, ModernWallet / themodernwallet.com)

## PAGE
- route: /guides/intentionally-defective-grantor-trust-idgt/
- slug: intentionally-defective-grantor-trust-idgt
...
## KEYWORDS + INTENT
- primary keyword: intentionally defective grantor trust
- secondary keywords (DataForSEO volume, US): idgt (2,900/mo, $8.08 CPC); intentionally defective grantor trust (2,900); idgt pros and cons; idgt step-up basis; idgt example; idgt vs irrevocable trust
- intent: Definitional + pros/cons intent for the GRAT's long-horizon sibling. Reader has usually just encountered the acronym.

## SERP EVIDENCE (live read, DataForSEO)
Live SERP (DataForSEO, 2026-09-21): verdict winnable. Page one = fidelity.com, nationaladvisors.com, investopedia.com, saul.com, gsrm.com, yanowitzlaw.com, thetaxadviser.com, cmrs-law.com, peaktrust.com, farmland.org - only 2/10 major platforms. AI Overview present, citing fidelity.com, thetaxadviser.com, gsrm.com, nationaladvisors.com, youtube.com, yanowitzlaw.com, peaktrust.com, btcpa.net. Related searches: disadvantages of IDGT; IDGT step-up basis; IDGT example; IDGT pros and cons; IDGT vs irrevocable trust. AEO REQUIREMENT: first sentence of introText must explain what 'intentionally defective' means, extractably.

## FAQ SPEC — use these REAL People-Also-Ask questions, verbatim as the `faqs[].question` values
  1. What is a disadvantage of an intentionally defective grantor trust?
  2. What is the difference between an intentionally defective grantor trust (IDGT) and a GRAT?
  3. Does an intentionally defective grantor trust get a step-up in basis?
  4. Who pays taxes on an IDGT?
  5. Does an intentionally defective grantor trust file a tax return?
  6. What is the seed gift for an IDGT?
...
1. What 'intentionally defective' means - outside the estate for estate tax, inside it for income tax, deliberately (IRC 671-679).
2. The installment-sale mechanic: seed gift, sale of assets for a promissory note, note interest, growth above the note rate accruing outside the estate. Label the ~10% seed as a planning convention, not a rule.
3. Why the grantor paying the trust's income tax is a feature, not a bug (Rev. Rul. 2004-64 - not an additional gift), and why the sale itself is not an income-taxable event (Rev. Rul. 85-13).
4. The basis problem: no step-up at the grantor's death, because the assets are outside the estate. Explain the capital-gains trade-off against estate tax savings plainly.
5. Disadvantages: irrevocability, the ongoing personal income tax burden, valuation risk on the assets sold, note-servicing discipline, cost and complexity, and the fact that the structure depends on drafting that must hold up under scrutiny.
6. Does it file a return - grantor trust reporting explained; link /guides/trust-tax-rates-explained/.
7. IDGT vs GRAT in three sentences, with the link out to /compare/grat-vs-idgt/ for the full comparison (short term + mortality risk + near-zero gift vs long horizon + seed gift + no fixed term).
8. Who it fits (long horizon, assets expected to appreciate a lot, a grantor comfortable paying the trust's tax for years) and who it does not.
9. Cost and the team required; link /guides/advanced-estate-planning-strategies/.
