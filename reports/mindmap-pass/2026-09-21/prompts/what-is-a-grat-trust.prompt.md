# ROW PROMPT — what-is-a-grat-trust (guide page, ModernWallet / themodernwallet.com)

## PAGE
- route: /guides/what-is-a-grat-trust/
- slug: what-is-a-grat-trust
...
## KEYWORDS + INTENT
- primary keyword: grat trust
- secondary keywords (DataForSEO volume, US): grat grantor retained annuity trust (1,600/mo); what is a grat trust (1,300); grat trust (1,000); grat definition (210); grat example (70); grat trust explained (40); grat trust pros and cons (20); how does a grat trust work (20); grantor retained annuity trust taxation (10)
- intent: Definitional head term with how-it-works, pros/cons, cost and (new this week) IRS-scrutiny intent. The reader has just read a news story about the IRS challenging GRATs and wants to understand what one actually is.

## SERP EVIDENCE (live read, DataForSEO)
Live SERP (DataForSEO, 2026-09-21): verdict winnable. Page one = fidelity.com, marinerwealthadvisors.com, investopedia.com, en.wikipedia.org, nationaladvisors.com, cnb.com, northwesternmutual.com, law.cornell.edu, sterlingtonlaw.com. AI Overview present, citing fidelity.com, investopedia.com, marinerwealthadvisors.com, nationaladvisors.com. No featured snippet. Not forum-dominated. Recommended shape: standard article/guide is viable. AEO REQUIREMENT: the first sentence of introText must define a GRAT completely on its own, in one extractable sentence.

## FAQ SPEC — use these REAL People-Also-Ask questions, verbatim as the `faqs[].question` values
  1. What are the disadvantages of a GRAT trust?
  2. Who pays taxes on a GRAT?
  3. How much does it cost to set up a GRAT?
  4. How long does a GRAT last?
  5. What is the point of a GRAT trust?
  6. Is a GRAT an irrevocable trust?
...
1. What a GRAT is, in one paragraph (the transfer, the retained annuity, the term, the remainder).
2. How a GRAT actually works, step by step (fund it; annuity paid at least annually; term ends; remainder passes). Name IRC 2702 and Treas. Reg. 25.2702-3.
3. The Section 7520 hurdle rate - what it is, that it is published monthly, that September 2026 is 5.40%, and that the rate for the FUNDING MONTH is what the GRAT is locked to. Link the IRS 7520 page. Include ONE clearly-labelled hypothetical illustration.
4. Zeroed-out GRATs and why they use almost no lifetime exemption (tie to the $15M 2026 exemption; link /guides/gift-tax-limit-2026/).
5. Mortality risk and the other downsides (IRC 2036 pull-back, legal cost, no upside if assets underperform, irrevocability).
6. Who pays the tax (grantor trust for income tax; Form 709 at funding; link /guides/form-709-gift-tax-return/).
7. What a GRAT costs to set up (the $2,500-$10,000+ range, labelled as typical) and who you need (attorney, CPA, advisor).
8. Why the IRS is challenging GRATs in 2026 - the WSJ-reported Elcan/HCA Tax Court dispute, attributed and hedged exactly as the fact list requires, plus what the enforcement focus means practically (pay the annuity at least annually, value hard-to-value assets defensibly, keep the paperwork). MUST NOT say the IRS won or that GRATs are illegal.
9. Who a GRAT is and is not for; pointer to /compare/grat-vs-idgt/ and /compare/grat-vs-slat/ and /guides/rolling-grat-strategy/.
