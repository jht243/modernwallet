# ROW PROMPT — slat-trust-explained (guide page, ModernWallet / themodernwallet.com)

## PAGE
- route: /guides/slat-trust-explained/
- slug: slat-trust-explained
...
## KEYWORDS + INTENT
- primary keyword: slat trust
- secondary keywords (DataForSEO volume, US): slat trust (1,900/mo); spousal lifetime access trust (590, $6.09 CPC); slat trust pros and cons; slat trust disadvantages; slat trust taxation; slat trust cost; is a slat a grantor trust
- intent: Definitional + risk/cost intent. The reader is weighing whether to lock in lifetime exemption without fully giving up access to the money.

## SERP EVIDENCE (live read, DataForSEO)
Live SERP (DataForSEO, 2026-09-21): verdict winnable. Page one = schwab.com, fidelity.com, fiduciary-trust.com, anzlaw.thomsonreuters.com, becker.com, dbllawyers.com, justvanilla.com, youtube.com, glenmede.com, parmanlaw.com. AI Overview present, citing schwab.com, fidelity.com, becker.com, fiduciary-trust.com, youtube.com, parmanlaw.com. Related searches: SLAT trust pros and cons; SLAT trust disadvantages; SLAT trust taxation; SLAT trust cost; is a SLAT a grantor trust. AEO REQUIREMENT: first sentence of introText must define a SLAT completely on its own.

## FAQ SPEC — use these REAL People-Also-Ask questions, verbatim as the `faqs[].question` values
  1. What are the potential drawbacks of a SLAT trust?
  2. What is the difference between a SLAT and a QTIP trust?
  3. Who pays the taxes on a SLAT?
  4. What happens to a SLAT when the beneficiary spouse dies?
  5. Is a SLAT a grantor trust?
  6. How much does a SLAT cost to set up?
...
1. What a SLAT is, in one extractable sentence (one spouse creates an irrevocable trust for the other, using the donor's lifetime exemption, while keeping indirect access through the beneficiary spouse).
2. Why people use one: it locks in the $15M 2026 exemption as a completed gift while the money stays reachable through the spouse. Link /guides/gift-tax-limit-2026/.
3. How the access actually works and what it is NOT - the donor is not a beneficiary; access is indirect, discretionary, and depends entirely on the marriage continuing.
4. The three real risks, given equal weight: divorce (access runs through the spouse), death of the beneficiary spouse (access ends and the donor cannot reclaim it), and the reciprocal trust doctrine when both spouses create mirror SLATs.
5. Taxation: a SLAT is typically a grantor trust, so the donor pays the income tax; funding is a completed gift reportable on Form 709 (link /guides/form-709-gift-tax-return/).
6. SLAT vs QTIP in a short paragraph (the real PAA question) - a QTIP is a marital-deduction trust for a surviving spouse, a SLAT is a lifetime gift that uses exemption now; do not overstate beyond the fact list, keep it at that level.
7. What it costs and the team needed (the $2,500-$10,000+ irrevocable-trust range, labelled typical).
8. Who a SLAT fits and who it does not; pointers to /compare/grat-vs-slat/ and /compare/revocable-vs-irrevocable-trust/.
