# ROW PROMPT — grat-vs-idgt (comparison page, ModernWallet / themodernwallet.com)

## PAGE
- route: /compare/grat-vs-idgt/
- slug: grat-vs-idgt
...
## KEYWORDS + INTENT
- primary keyword (targetKeyword): grat vs idgt
- secondary keywords (DataForSEO volume, US): grat vs idgt (30/mo); grat vs idgt taxes; grat vs idgt cost
- intent: Bottom-funnel evaluation intent. Reader is deciding which structure to use for a specific asset.

## SERP EVIDENCE
Live SERP (DataForSEO, 2026-09-21): verdict winnable, ZERO major platforms on page one - avidianwealth.com, daytonestateplanninglaw.com, cmrs-law.com, lbmc.com, learn.valur.com, hcvt.com, claconnect.com, bottestateplanning.com, greenleaftrust.com, saul.com. AI Overview present, citing daytonestateplanninglaw.com, cmrs-law.com, claconnect.com, learn.valur.com, bottestateplanning.com, commercetrustcompany.com, smith-howard.com.
...
## FAQ SPEC — use these REAL People-Also-Ask questions, verbatim as the `faqs[].question` values
  ...
  2. What are the disadvantages of an Intentionally Defective Grantor Trust (IDGT)?
  3. What is the difference between a grantor trust and an Intentionally Defective Grantor Trust?
  4. What happens to a GRAT when the grantor dies?
  5. Who pays taxes on a GRAT?
  6. What happens to an IDGT when the grantor dies?
...
- Core mechanic (retained annuity for a fixed term vs installment sale for a promissory note)
- Taxable gift at funding (near zero if zeroed out vs the seed gift, which uses exemption)
- Time horizon (short, commonly 2-10 years vs long, no fixed term)
- Mortality risk (assets pulled back into the estate under IRC 2036 if the grantor dies in the term vs no fixed-term mortality cliff; the note balance remains in the estate)
- Who pays the income tax (grantor in both - this is where they are the same)
- Step-up in basis at death (neither delivers a step-up on assets successfully transferred out; be precise and do not overstate)
- Exemption consumption (near zero vs the seed gift)
- Statutory/valuation risk exposure (IRC 2702 / Treas. Reg. 25.2702-3 formality and the current IRS enforcement focus vs valuation and note-rate risk)
- Asset fit (volatile, liquid, sharply appreciating positions vs long-horizon assets including illiquid or discountable interests)
- Cost and complexity (per-trust drafting, repeated for rolling programmes vs one structure with ongoing note administration)

## VERDICT + RELATED
verdict must name the deciding condition, not a blanket winner. Roughly: a GRAT fits a grantor who wants near-zero gift-tax exposure on a volatile, liquid, sharply appreciating asset and can survive a short term; an IDGT fits a grantor with a long horizon who is willing to spend some exemption on a seed gift and to pay the trust's income tax for years. Neither is the automatic winner.
...
Include the WSJ-reported IRS enforcement context in ONE section only, attributed and hedged exactly as the fact list requires.
