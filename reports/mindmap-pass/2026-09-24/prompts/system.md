...
{
  "updated": "2026-09-01",
  "slug": "qlac-qualified-longevity-annuity-contract",
  "title": "QLAC (Qualified Longevity Annuity Contract) Explained",
  "metaDescription": "A QLAC lets you shelter up to $210,000 from required withdrawals until age 85. See the 2026 IRS limit, which accounts qualify, and who it fits.",
  ...
  "tools": [
    ...
    {
      "href": "/compare/pension-vs-annuity/",
      "label": "Pension vs. annuity"
    },
    {
      "href": "/guides/roth-conversion-rules/",
      "label": "Roth conversion rules"
    }
  ],
  "faqs": [
    {
      "question": "What is a QLAC?",
      "answer": "A Qualified Longevity Annuity Contract (QLAC) is a deferred income annuity purchased inside a traditional IRA, 401(k), 403(b), or 457(b) plan. The premium is excluded from your required minimum distribution calculation until the annuity starts paying, which can be delayed as late as age 85."
    },
    {
      "question": "What is the QLAC limit for 2026?",
      "answer": "The 2026 QLAC premium limit is $210,000 per person, unchanged from 2025, according to IRS Notice 2025-67. The limit applies across all of your IRAs and workplace retirement plans combined, so each individual account does not get its own separate $210,000."
    },
    {
      "question": "How does a QLAC affect my RMDs?",
      "answer": "The money you put into a QLAC is removed from the account balance the IRS uses to calculate your required minimum distributions, starting the year you buy it and continuing until the annuity begins paying. That can lower your taxable RMDs in the years before payments start, though the payments themselves are taxed as ordinary income once they begin."
    },
    {
      "question": "Can I fund a QLAC with a Roth IRA?",
      "answer": "No. A QLAC can only be funded from a traditional IRA, 401(k), 403(b), or governmental 457(b) plan. Roth accounts already have no lifetime RMD requirement, so there is no RMD to defer inside one."
    },
    {
      "question": "How are QLAC payments taxed?",
      "answer": "QLAC payments are taxed as ordinary income in the year you receive them, the same as any other withdrawal from a traditional IRA or 401(k). The premium itself was pre-tax money, so nothing about a QLAC makes the eventual payout tax-free."
    },
    {
      "question": "What happens to my QLAC money if I die before payments start?",
      "answer": "Without an added death benefit, the insurance company keeps the remaining premium if you die before your chosen start date. A return-of-premium or joint-life option can protect a spouse or heir, but choosing one lowers the monthly income the contract eventually pays."
    },
    {
      "question": "Is this QLAC information financial advice?",
      "answer": "No. This page explains how a QLAC works and what the current IRS rules require. It is not personalized investment, tax, or retirement advice. Whether a QLAC fits your own retirement plan depends on your account balances, health, and tax bracket, so talk to a licensed financial advisor or tax professional before buying one."
    }
  ],
  "sources": [
    {
      "label": "IRS — Notice 2025-67: 2026 Amounts Relating to Retirement Plans and IRAs",
    ...
    {
      "label": "Congress.gov — SECURE 2.0 Act of 2022 (H.R. 2617, Division T)",
