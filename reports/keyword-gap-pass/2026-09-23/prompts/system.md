...
{
  "slug": "dave-ramsey-12-percent-investment-return-explained",
  "updated": "2026-09-16",
  "title": "Investment Calculator Dave Ramsey: The 12% Return Explained",
  "metaDescription": "Before setting an investment calculator Dave Ramsey return at 12%, see what the historical data shows for nominal versus inflation-adjusted S&P 500 returns.",
  "h1": "Investment Calculator Dave Ramsey Assumptions and the 12% Return",
  "cardBlurb": "Ramsey's 12% figure is a real, sourced nominal average, but it runs higher than the inflation-adjusted long-run figure most other sources cite.",
  ...
  "faqs": [
    { "question": "What is Dave Ramsey's 12% investment return rule?", "answer": "Dave Ramsey's 12% return rule is his guideline that long-term investors can plan around an average annual return near 12% for stock market investing over multi-decade horizons. Ramsey Solutions bases this figure on the historical arithmetic average annual return of the S&P 500 from 1928 through 2025, which Ramsey Solutions measures at 11.86% and rounds up to 12%." },
    { "question": "Does Dave Ramsey's 12% figure account for inflation?", "answer": "No, Dave Ramsey's 12% figure does not account for inflation. The 11.86% historical average cited on the Ramsey Solutions website is an unadjusted nominal return figure that reflects raw dollar growth rather than inflation-adjusted purchasing power." }
  ],
  "sources": [
    { "label": "Ramsey Solutions", "url": "https://www.ramseysolutions.com/retirement/the-12-reality" },
    { "label": "officialdata.org", "url": "https://www.officialdata.org/us/stocks/s-p-500/1926" }
  ]
}
