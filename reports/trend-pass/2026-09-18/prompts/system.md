...
## RULES THAT OUTRANK EVERYTHING BELOW (anti-AI language, WRITER section)
...
## DOMAIN — who "we" are (the only source for any first-person claim)
...
## STRUCTURE, SEO, DEPTH, SOURCING, STYLE RULES (content standard)
