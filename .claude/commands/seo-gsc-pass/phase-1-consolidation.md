...
3. **Write the advisory** to `reports/seo-pass/<date>.cannibalization.md`, and surface every pair in the Phase 8 summary so the user sees it before approving.
...
- ☐ the advisory is recorded in `reports/seo-pass/<date>.cannibalization.md` and will appear in the Phase 8 summary
