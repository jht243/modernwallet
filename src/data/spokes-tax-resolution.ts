...
export const TAX_RESOLUTION_SPOKES: SpokeEntry[] = [
  {
    ...
    introText:
      "An offer in compromise calculator uses the IRS's own math (Reasonable Collection Potential (RCP)) to show the minimum offer amount the IRS is likely to accept for your tax debt. The calculator above follows the same method as IRS Form 656-B: Net Realizable Equity in your assets, plus 12 months of remaining monthly income for a Lump-Sum Cash Offer or 24 months for a Periodic Payment Offer.\n\nFor someone who owes $55,000, has $37,990 in Net Realizable Equity, and has $500 in remaining monthly income, the lump-sum RCP is $43,990 (about $11,010 less than the debt) making it a mathematically viable Offer in Compromise.",
    howItWorks:
...

  {
    ...
    faqs: [
      ...
      {
        question: "Does an installment agreement stop the IRS from filing a tax lien, or get an existing lien released?",
        answer:
      ...
      {
        question: "Does an IRS installment agreement affect my credit score, mortgage approval, or passport?",
        answer:
    ...
    sources: [
      ...
      { label: "IRS — Refund offsets for federal or state debts", url: "https://www.irs.gov/taxtopics/tc203" },
    ],
...

  {
    ...
    introText:
      "An IRS penalty abatement calculator directs your penalty to the right relief mechanism: First Time Abate (an administrative waiver that's essentially automatic when you meet three criteria) or Reasonable Cause, a case-by-case request covering a broader set of penalties.\n\nThe calculator above applies IRS rules. First Time Abate covers failure-to-file (§6651(a)(1)), failure-to-pay (§6651(a)(2)), and failure-to-deposit (§6656) penalties, but not the accuracy-related penalty under §6662.\n\nFor a $2,400 failure-to-file penalty, First Time Abate wipes out the full $2,400 if you've been penalty-free for the prior 3 tax years, all required returns are filed, and the tax is paid or under an installment agreement. The likelihood is high because FTA is granted almost automatically when the criteria are met.",
    howItWorks:
...

  {
    ...
    introText:
      "A back taxes impact calculator lays out the real-world consequences of IRS debt: mortgage approval, passport eligibility, credit report visibility, wage garnishment risk, professional license status, and the number of years left on the 10-year Collection Statute Expiration Date.\n\nThe calculator above applies IRS rules to your situation and gives you a plain-English impact grid. For example, with a $45,000 balance assessed 3 years ago, no tax lien filed, and no installment agreement in place, the CSED runs out in about 7 years. Your credit report is clean because the 3 credit bureaus stopped showing tax liens in April 2018. However, a mortgage application would be flagged until you set up a formal installment agreement and make 3 on-time monthly payments.",
    howItWorks:
