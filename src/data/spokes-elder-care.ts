...
export const ELDER_CARE_SPOKES: SpokeEntry[] = [
  {
    ...
    introText:
      "A Medicaid spend-down calculator shows how much of your countable assets you must spend (on care, exempt purchases, or protected transfers) before institutional Medicaid will pay for a nursing home. Although the federal asset limit is $2,000 for the applicant, every state has its own overlay. California re-added an asset test on January 1, 2026, setting the limit at $130,000 for an individual and $195,000 for a couple. New York uses $33,038, while Illinois uses $17,500.\n\nTwelve states plus D.C. use the maximum home-equity limit of $1,130,000 in 2026; the other 38 use the federal minimum of $752,000. About twenty states are \"income-cap\" states. If your monthly income exceeds $2,982, these states require a Qualified Income Trust (Miller Trust under 42 U.S.C. §1396p(d)(4)(B)).\n\nThe calculator applies your state's actual figures and shows the exact spend-down target, the dollar amount you need to spend before Medicaid pays.",
    howItWorks:
...

  {
    ...
    commonMistakes: [
      ...
      "Giving the beneficiary a direct gift or inheritance instead of funding a trust. Cash or property handed straight to an SSI/Medicaid recipient counts toward the $2,000 federal resource limit and can end benefits the same month. Check the [Medicaid spend-down calculator](/elder-care/medicaid-spend-down-calculator/) before assuming a small gift is harmless; a properly drafted SNT is what lets family money reach the beneficiary without crossing that limit.",
      ...
      "Self-drafting an SNT. SSI and Medicaid regulators routinely reject self-drafted SNTs, disqualifying the beneficiary from benefits. Every SNT must be drafted by an [elder-law attorney experienced in special-needs planning](/compare/elder-law-attorney-vs-estate-planning-attorney/) — the state Medicaid agency and Social Security review the trust document.",
    ...
    faqs: [
      ...
      {
        question: "Can a first-party SNT be converted to a third-party SNT?",
        answer:
      ...
      },
      {
        ...
        answer:
          "There is no dollar cap on how much a properly drafted special needs trust can hold. That's the key difference from an [ABLE account](/compare/special-needs-trust-vs-able-account/), which caps annual contributions. Under POMS SI 01120.200, an SNT's assets are excluded as a countable SSI and Medicaid resource regardless of size, as long as the trust meets the federal requirements for its type.",
      },
      {
      ...
      {
        question: "Who should be the trustee of a special needs trust?",
        answer:
      ...
      {
        question: "Can a family member serve as trustee, or does it have to be a professional or bank?",
        answer:
      ...
      {
        question: "Are there ongoing costs after the trust is set up, like annual trustee fees?",
        answer:
...

  {
    ...
    commonMistakes: [
      ...
      "Waiting too long to start Medicaid planning. Any transfer within 60 months of application triggers a penalty under 42 U.S.C. §1396p(c). If projected shortfall is high, a Medicaid Asset Protection Trust or protected transfers should be funded 5+ years before care is needed. Our [elder care planning checklist](/guides/elder-care-planning-checklist/) covers the legal documents and family conversations worth having in place before that clock starts running.",
