...
export const PROBATE_SPOKES: SpokeEntry[] = [
  {
    ...
    introText:
      "A probate fee calculator shows the actual attorney and executor fees your estate will owe based on where you live. Nine states set these fees by statute. California follows the tiered schedule in Cal. Prob. Code §10810 (4%/3%/2%/1%/0.5%), while Florida uses the stepped-base plus percentages in Fla. Stat. §733.6171. The 7 others include Iowa, Missouri, Montana, New York (executor only), Wyoming, Arkansas, Oklahoma, and New Jersey (executor only).\n\nThe remaining ~41 states use a reasonable-fee model, typically charging roughly 2-4% of the gross estate. For a $750,000 moderate probate in California, statutory fees alone come to about $18,000 for the attorney and another $18,000 for the executor, a total of $36,000 that a $2,000-$6,750 revocable living trust would have avoided entirely.",
    howItWorks:
    ...
    faqs: [
      ...
      {
        question: "How much are probate fees in Michigan, Missouri, Connecticut, South Dakota, or Virginia?",
        answer:
    ...
    sources: [
      ...
      { label: "MCL §700.3719 — Michigan personal representative compensation", url: "https://www.legislature.mi.gov/Laws/MCL?objectName=MCL-700-3719" },
      { label: "Conn. Gen. Stat. §45a-107 — probate court fees", url: "https://www.ctprobate.gov/documents/sec-45a-107.pdf" },
      { label: "SDCL §29A-3-719 — South Dakota personal representative compensation", url: "https://sdlegislature.gov/Statutes/29A-3-719" },
      { label: "Virginia Tax — Probate Tax", url: "https://www.tax.virginia.gov/probate-tax" },
...

  {
    ...
    introText:
      "A probate timeline calculator shows how many months it takes to close an uncontested estate in your state. Texas closes fastest: independent administration under Tex. Est. Code §401.001 takes 3-6 months. In Uniform Probate Code informal states (Utah, Colorado, Arizona, Minnesota, and Idaho) the process takes 4-8 months.\n\nCalifornia takes 12-24 months because Cal. Prob. Code §9100 sets a 4-month creditor claim period, and urban courts face backlogs. New York Surrogate's Court also takes 12-24 months for anything beyond voluntary administration under SCPA Article 13, which applies to personal property under $50,000.\n\nContested probate takes 2-5 years everywhere. For a moderate California estate with one property to probate, expect the process to take 15-30 months.",
    howItWorks:
...

  {
    ...
    introText:
      "A probate-vs-living-trust calculator shows the exact tradeoff between what probate will cost your estate at death (attorney fees, executor commission, court costs, and ancillary probate) and what a revocable living trust would cost to set up during life: $1,500-$5,000 with an attorney or $499-$599 online.\n\nThe calculator above works out both costs for your specific state and estate value. For a $750,000 California moderate estate, probate runs $36,000-$42,000 and takes 15-30 months. A California revocable living trust costs $2,025-$6,750 today. By setting up the trust now, the net savings are $30,000-$40,000, plus 12+ months of estate settlement time.",
    howItWorks:
