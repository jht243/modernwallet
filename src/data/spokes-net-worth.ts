...
export const NET_WORTH_SPOKES: SpokeEntry[] = [
...

  {
    ...
    introText:
      "The net worth by age calculator above shows how your finances compare with those of the typical American household in your age range. Enter your assets and debts, and the tool will calculate your net worth and show the U.S. median for your bracket. These benchmarks come directly from the Federal Reserve's 2022 Survey of Consumer Finances, the most authoritative source on household wealth.",
    howItWorks:
...

  {
    ...
    introText:
      "The liquid net worth calculator above shows how much of your wealth you can actually spend today. Liquid net worth is calculated by subtracting your total debts from only your liquid assets, while leaving out retirement accounts, homes, and vehicles. The result gives you a more honest picture of your short-term financial safety than standard net worth.",
    howItWorks:
      "Liquid net worth equals your liquid assets minus your total liabilities. Liquid assets are the things you can turn into cash within a few days without losing significant value: checking and savings balances, money market accounts, taxable brokerage holdings, and short-term certificates of deposit.\n\nWhat does not count as liquid: 401(k) and IRA balances (a 10% early-withdrawal penalty plus income tax apply before age 59½, per IRS Topic 558), home equity (selling takes months), vehicles, business interests, collectibles, and generally the cash value built up inside a life insurance policy, since accessing it usually means [borrowing against the policy](/guides/borrowing-against-life-insurance/) rather than a same-day withdrawal. Enter only your truly accessible assets above, then subtract every debt you owe, from credit cards to auto and student loans.",
    commonMistakes: [
    ...
    faqs: [
      ...
      { question: "How much liquid net worth should I have?", answer: "There is no single rule, but the CFPB's emergency fund guidance is really a liquid net worth target: enough accessible cash to cover the unexpected expenses you have actually faced in the past. Many planners suggest three to six months of essential expenses in liquid form for a household with steady W-2 income. Self-employed households and anyone with variable or commission-based income commonly need a bigger buffer, since a slow month or a lost client can cut off income with no notice. A widely cited norm for that situation is six to twelve months of essential expenses instead." },
      ...
      { question: "How is this different from regular net worth?", answer: "Standard net worth counts every asset you own, including homes, cars, and retirement accounts. Liquid net worth counts only assets you could turn into spendable cash within days without penalty. See [how to calculate net worth](/net-worth/how-to-calculate-net-worth/) for the broader version, and the [net worth percentile calculator](/net-worth/net-worth-percentile-calculator/) to see how a total net worth figure like $2 million ranks among U.S. households." },
      ...
      { question: "How many Americans have $1,000,000 in liquid assets?", answer: "There's no published national count of households holding $1 million or more in strictly liquid assets specifically. The closest public benchmark is total net worth: the Federal Reserve's Survey of Consumer Finances puts the top-10% cutoff at roughly $1.46 million in total net worth, which includes home equity and retirement accounts alongside cash and investments. Because liquid assets alone are almost always a smaller slice of that total figure, the true liquid-only threshold sits meaningfully lower than $1.46 million, just not at a number the SCF publishes directly. See the [net worth percentile calculator](/net-worth/net-worth-percentile-calculator/) for the full set of total-net-worth cutoffs." },
    ],
    sources: [
...

  {
    ...
    introText:
      "The net worth percentile calculator shows how your household wealth compares with that of all U.S. households, based on data from the Federal Reserve's 2022 Survey of Consumer Finances. Enter your assets and debts above to see your net worth and its corresponding percentile. Conducted every three years, the SCF is the gold-standard source on U.S. household wealth and includes roughly 5,000 families.",
    howItWorks:
...

  {
    ...
    introText:
      "A household net worth calculation brings both partners' assets and liabilities together into one number, giving you a clear picture of your shared financial position. That's exactly why the Federal Reserve's Survey of Consumer Finances, the authoritative source on U.S. household wealth, measures net worth at the household level. Enter both partners' figures in the calculator above, then read on to see what joint tracking reveals that individual tracking misses.",
    howItWorks:
...

  {
    ...
    introText:
      "A net worth projection calculator uses your current net worth, annual savings, and expected investment return to estimate where you'll be financially in 5, 10, and 20 years. Your starting point is today's snapshot, your assets minus your debts. This spoke shows you how to use that number as the foundation for a forward-looking projection, helping you see when key milestones such as $500,000 or $1 million become reachable.",
    howItWorks:
  ...
  // page type: explainer/spoke (1200-word floor); teeup-exempt (opening sentence is already a direct-answer claim).
  {
    ...
    introText:
      "Yes, this net worth calculator works in any currency because the math is always the same: add up what you own, then subtract what you owe. Whether you use Canadian dollars, British pounds, Indian rupees, or U.S. dollars, the total means the same thing.\n\nWhat changes from country to country is the benchmark you compare that total against, since each country's median household wealth comes from its own national survey. Canada's benchmark comes first, followed by where to find the same kind of data for the UK, Australia, India, and several other countries.",
    howItWorks:
