...
export const NET_WORTH_SPOKES: SpokeEntry[] = [
...

  {
    ...
    faqs: [
      ...
      { question: "How many Americans have $1,000,000 in liquid assets?", answer: "The Federal Reserve's Survey of Consumer Finances doesn't publish a liquid-only breakdown, so there's no official count of households holding $1 million or more in strictly cash and easy-to-sell investments. Its closest published figure is the top-10% cutoff for total net worth, roughly $1.46 million, but that number folds in home equity and retirement accounts alongside liquid holdings, so it overstates how many households actually clear $1 million in liquid assets alone. See the [net worth percentile calculator](/net-worth/net-worth-percentile-calculator/) for the full set of total-net-worth cutoffs." },
    ],
    sources: [
