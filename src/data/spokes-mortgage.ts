...
export const MORTGAGE_SPOKES: SpokeEntry[] = [
...

  {
    ...
    howItWorks:
      "The VA Home Loan program is guaranteed by the U.S. Department of Veterans Affairs, which allows VA-approved lenders to offer favorable terms with no down payment requirement and no PMI. The guarantee reduces lender risk, which is why rates run lower than conventional.\n\nThe VA funding fee replaces PMI as the program's cost-recovery mechanism, and it scales with your down payment and how many times you've used the benefit. For a purchase loan with 0% down, the fee is 2.15% of the loan amount for first-time use and 3.3% for subsequent use. Putting down 5% to 9.99% drops the fee to 1.5% for both first-time and subsequent use, and putting down 10% or more drops it further to 1.25% for both. A VA cash-out refinance follows the same 2.15%/3.3% purchase schedule based on first or subsequent use, while a VA Interest Rate Reduction Refinance Loan (IRRRL, the VA's streamline refinance) carries a flat 0.5% fee regardless of down payment or prior use. Service members receiving VA disability compensation of any percentage are exempt from the funding fee entirely, a significant savings. The funding fee is added to the loan balance if not paid at closing, which slightly increases your monthly P&I.",
    commonMistakes: [
    ...
    faqs: [
      ...
      {
        question: "What is the VA funding fee for a refinance?",
        answer:
          "A VA cash-out refinance follows the same 2.15% (first use) or 3.3% (subsequent use) schedule as a purchase loan. A VA Interest Rate Reduction Refinance Loan (IRRRL), the VA's streamline refinance, carries a flat 0.5% fee regardless of down payment or how many times you've used your VA benefit.",
      },
    ],
    sources: [
