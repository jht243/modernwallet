...
export const MORTGAGE_SPOKES: SpokeEntry[] = [
  {
    ...
    introText:
      "A mortgage payoff calculator shows when you'll pay off your loan and how much interest you can save with extra payments. Enter your balance, rate, term, and any extra monthly amount in the calculator above to instantly see your new payoff date.\n\nThe biggest takeaway is that paying extra principal early in a 30-year loan saves far more than paying the same amount near the end. That's because interest is charged on your remaining balance, so reducing it sooner prevents more interest from ever accruing.",
    howItWorks:
...

  {
    ...
    introText:
      "This mortgage extra payment calculator shows how much time and interest you can save by paying more than your required monthly amount. Enter your balance, rate, term, and extra payment above to see your new payoff date. Even a small extra monthly payment can shave years off a 30-year loan. The calculator does the math, letting you compare scenarios in seconds.",
    howItWorks:
...

  {
    ...
    introText:
      "A mortgage amortization calculator shows how each monthly payment is divided between principal and interest until your loan balance reaches zero. The calculator above creates a complete month-by-month schedule, letting you see your balance shrink and your equity grow. Amortization simply means paying off a loan through regular payments over time. Here's the surprising part: early payments go mostly toward interest, not principal.",
    howItWorks:
...

  {
    ...
    introText:
      "A pay off mortgage early calculator shows you how extra monthly payments can shorten your loan and slash the total interest you pay. Enter your balance, rate, term, and extra payment in the calculator above to instantly see your new payoff date. The results can help you decide whether paying down your mortgage beats other uses for that money. Before you commit, use the calculator to compare a few extra-payment amounts.",
    howItWorks:
...

  {
    ...
    introText:
      "PITI stands for Principal, Interest, Taxes, and Insurance, the four components of your true all-in monthly mortgage payment. The calculator above shows your principal and interest (P&I). Add your estimated property taxes and homeowner's insurance below to calculate your full PITI.\n\nWhy does this matter? When applying the 28% front-end debt-to-income (DTI) rule, lenders use your PITI, not just P&I. That means your PITI must remain below 28% of your gross monthly income to qualify for most conventional loans.",
    howItWorks:
...

  {
    ...
    introText:
      "Two lender rules determine the maximum home price you can afford: your PITI must be no more than 28% of your gross monthly income (front-end DTI), and your combined monthly debts must be no more than 36% of your gross monthly income (back-end DTI).\n\nThe calculator above shows the principal-and-interest payment for any home price. Use the 28% front-end limit to work backward and find a purchase price that fits your income.\n\nHere's the less obvious part: keeping your DTI under 36% does more than help you get approved. Lenders often tier interest rates by DTI, so a lower DTI can earn you a better rate, not just a lender's yes.",
    howItWorks:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "The math above (28% front-end, 36% back-end) is the same underlying formula lenders use for jumbo and USDA loans, but both have different limits worth knowing. Jumbo loans are anything above the [FHFA conforming loan limit](https://www.fhfa.gov/data/conforming-loan-limit) ($832,750 in most counties for 2026) and typically require a larger down payment and stronger credit — some jumbo lenders keep the loan in-house as a [portfolio loan](/guides/portfolio-loan-mortgage-explained/) rather than selling it, which changes the underwriting. USDA loans use a stricter 29/41 DTI cap and a 1% upfront guarantee fee, per the [USDA Single Family Housing Guaranteed Loan Program](https://www.rd.usda.gov/programs-services/single-family-housing-programs/single-family-housing-guaranteed-loan-program), but allow 0% down in eligible rural areas.",
      },
      {
...

  {
    ...
    introText:
      "A mortgage refinance is worth it only if you stay in the home long enough for the monthly savings to cover the closing costs. This is called the break-even point.\n\nEnter your new loan details in the calculator above to see the payment, then subtract that amount from your current payment to find your monthly savings. Divide your total closing costs by your monthly savings to calculate your break-even point in months.\n\nThe non-obvious trap is that even if you lower your rate, resetting to a new 30-year term can cost you more in total interest than staying on your existing loan. Always compare remaining-term options, such as a 20-year or 15-year refinance.",
    howItWorks:
...

  {
    ...
    introText:
      "For eligible veterans, active-duty service members, and surviving spouses, VA loans require no down payment or private mortgage insurance, making them the most powerful home-buying benefit available to eligible borrowers.\n\nInstead of PMI, VA loans have a one-time funding fee equal to 2.15% of the loan amount for first-time use with 0% down (2024 rate per VA.gov). That fee is typically financed into the loan.\n\nThe less obvious advantage is that VA loans consistently have the lowest average interest rates of any major loan type, historically 0.25 to 0.5% lower than conventional rates, according to Freddie Mac's Primary Mortgage Market Survey. Combined, the lower rate and lack of PMI save eligible borrowers thousands of dollars per year.",
    howItWorks:
      "The VA Home Loan program is guaranteed by the U.S. Department of Veterans Affairs, which allows VA-approved lenders to offer favorable terms with no down payment requirement and no PMI. The guarantee reduces lender risk, which is why rates run lower than conventional.\n\nThe VA funding fee replaces PMI as the program's cost-recovery mechanism. For first-time use with 0% down, the fee is 2.15% of the loan amount. For subsequent use, it rises to 3.3%. With a 5% or more down payment, the fee drops to 1.5% (first use) or 3.3% (subsequent use). Service members receiving VA disability compensation of any percentage are exempt from the funding fee entirely, a significant savings. The funding fee is added to the loan balance if not paid at closing, which slightly increases your monthly P&I. If you're weighing VA against FHA, see our [FHA loan vs VA loan](/compare/fha-loan-vs-va-loan/) comparison for the full cost breakdown.",
    commonMistakes: [
...

  {
    ...
    introText:
      "With an interest-only (IO) mortgage, your monthly payment covers only the interest due. None of it reduces the principal balance during the IO period, which typically lasts 5 to 10 years. The calculator above shows your loan's principal-and-interest payment, while your IO payment is simply the monthly interest portion: loan balance × annual rate ÷ 12.\n\nOnce the IO period ends, the full remaining balance (unchanged from day one) amortizes over the remaining term, causing a significant increase in your payment. The critical risk is that IO loans build zero equity during the IO period, so a drop in home values can leave you underwater with no equity buffer.",
    howItWorks:
...

  {
    ...
    introText:
      "This home affordability calculator uses your income, debts, down payment, and mortgage rate to estimate how much house you can afford. Enter your numbers above to see your target home price and monthly payment. Lenders compare your income with your debts to determine how much you can borrow. Knowing what you can afford before you start shopping helps keep your search realistic and your budget safe.",
    howItWorks:
      "The calculator above applies the 28/36 rule, a common guideline lenders use to gauge affordability. Under this rule, your monthly housing payment should stay at or below 28% of your gross monthly income, and your total debt payments should stay at or below 36%. Your gross income is what you earn before taxes. The lower of these two limits sets your real budget.\n\nThe housing payment here means PITI, not just principal and interest. PITI stands for principal, interest, property taxes, and insurance. If your down payment is under 20%, lenders usually add private mortgage insurance (PMI), which raises the payment. Try our [down payment calculator](/mortgage/down-payment-calculator/) and [closing cost calculator](/mortgage/closing-cost-calculator/) to plan the cash you'll need up front.\n\nOne underwriting trap that stops otherwise-qualified buyers: unaddressed IRS back taxes. Fannie Mae, Freddie Mac, and FHA (Handbook 4000.1) will not underwrite while there's IRS debt outstanding unless you're on a formal long-term installment agreement AND have made at least 3 monthly payments on time. A recorded Notice of Federal Tax Lien blocks approval entirely until it's released, discharged, or subordinated to the new mortgage. If back taxes are in the picture, the [back taxes impact calculator](/tax-resolution/back-taxes-impact-calculator/) shows exactly what stops the loan and how to clear each block.",
    commonMistakes: [
...

  {
    ...
    introText:
      "This down payment calculator shows how much cash you'll need to buy a home and whether your down payment will trigger private mortgage insurance (PMI). Enter the home price and down payment percentage in the calculator above to see your down payment amount, loan amount, and loan-to-value (LTV) ratio.\n\nYou may be surprised to learn that you do not need 20% down. Conventional loans can require as little as 3% down, while FHA loans start at 3.5%. However, putting down less than 20% on a conventional loan usually means paying PMI until you build enough equity.",
    howItWorks:
...

  {
    ...
    islandId: "mortgage-extras",
    introText:
      "This closing cost calculator gives you a rough idea of what you'll pay at the closing table to complete your home purchase. Enter your home price above for an instant estimate.\n\nClosing costs typically range from about 2% to 5% of the home's price. For a $400,000 home, that works out to roughly $8,000 to $20,000, with a typical bill near $12,000, or about 3%. These fees cover the loan, title work, taxes, and prepaid items.\n\nOne key point many buyers miss: closing costs are separate from (and added on top of) your down payment. This calculator provides a planning estimate; the real numbers will appear on your official Loan Estimate from a lender.",
    howItWorks:
    ...
    faqs: [
      ...
      { question: "What is included in closing costs?", answer: "Closing costs include loan origination fees, appraisal and inspection, title insurance and search, recording and transfer taxes, and prepaid taxes and insurance for your escrow account. On a typical $400,000 purchase, these categories together total about $12,000. Transfer tax specifically varies a lot by state; see our [real estate transfer tax guide](/guides/real-estate-transfer-tax-explained/) for worked New Jersey and New York examples." },
