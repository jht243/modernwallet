...
export const INVESTING_SPOKES: SpokeEntry[] = [
...

  {
    ...
    commonMistakes: [
      ...
      "Ignoring the annual contribution limit. TSP contributions share the same Internal Revenue Service (IRS) elective-deferral limit as a private 401(k), so check the current-year limit on tsp.gov before assuming an unlimited amount can be contributed.",
    ],
    workedExample:
    ...
    faqs: [
      { question: "What is the TSP?", answer: "The Thrift Savings Plan (TSP) is the federal government's retirement savings and investment plan for federal employees and uniformed service members, run by the Federal Retirement Thrift Investment Board. It works much like a private-sector 401(k): contribute a portion of pay, choose from a set menu of funds, and the balance grows tax-deferred, or tax-free in the Roth TSP, until retirement." },
