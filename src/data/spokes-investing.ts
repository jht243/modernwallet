...
export const INVESTING_SPOKES: SpokeEntry[] = [
  {
    ...
    introText:
      "This compound interest calculator shows how your money can grow when you earn interest on your interest. Enter your starting amount, monthly contribution, expected return, and time period. You can also choose how often the interest compounds (from yearly to daily) and see the effect for yourself.",
    howItWorks:
    ...
    relatedSlugs: ["investment-growth-calculator", "roth-ira-calculator", "savings-goal-calculator", "annualized-return-calculator"],
  },

  {
    ...
    introText:
      "This investment growth calculator shows how your portfolio could grow when you invest a lump sum and make regular contributions. In the calculator above, enter your starting balance, monthly deposit, expected return, and time frame. You'll see your future balance, including how much comes from compounding growth and how much comes from the money you put in. These projections assume one fixed return, but real markets rise and fall each year. Considering a newly public company for that contribution? Read [what is an IPO](/guides/what-is-an-ipo/) before you buy on day one.",
    howItWorks:
    ...
    faqs: [
      ...
      { question: "What return rate should I use?", answer: "Match the rate to your investment mix. A broad U.S. stock portfolio has historically returned just over 10% per year before inflation, per FINRA, while bonds and cash return far less. A conservative or blended portfolio may justify a lower assumption like 6% to 8%. Some well-known personal-finance figures assume a flat 12% — see our breakdown of [Dave Ramsey's 12% return rule](/guides/dave-ramsey-12-percent-investment-return-explained/) for how that figure compares to the historical nominal and inflation-adjusted averages." },
...

  {
    ...
    faqs: [
      ...
      { question: "How much will $10,000, $20,000, or $100,000 make in a high-yield savings account?", answer: "At this page's example 4.5% APY with no further deposits, $10,000 earns about $450 in the first year, $20,000 earns about $900, and $100,000 earns about $4,500. Monthly compounding pushes the exact figure slightly above those simple estimates. These are lump-sum numbers with nothing added afterward, unlike the calculator's own worked example, which mixes a $10,000 start with a $300 monthly deposit. Enter your own balance above with the monthly deposit set to zero to see the precise lump-sum figure at your bank's current APY." },
      { question: "Should I put money in a high-yield savings account or pay off debt first?", answer: "A HYSA earning 4.5% loses to paying down any debt charging a higher rate, like most credit cards, and loses more clearly the higher that debt's rate runs. Money you might need soon still belongs in a HYSA for safety and access, even while you're also paying down debt. Our [pay off debt or invest](/guides/pay-off-debt-or-invest/) guide walks through the rate comparison for other debt types." },
...

  {
    ...
    introText:
      "This savings goal calculator shows you how much you need to save each month to reach your target by a set date. Enter your goal, starting balance, time frame, and expected return. The calculator above then works out the number that matters most: your required monthly contribution. It turns a giant, vague goal into a clear monthly habit you can actually track.",
    howItWorks:
...

  {
    ...
    introText:
      "A Roth IRA allows you to invest after-tax dollars today, with growth and qualified withdrawals in retirement completely tax-free. To project your balance, use the calculator above and enter your current savings, a monthly contribution up to the annual limit, your expected return, and your time horizon.\n\nAccording to IRS Publication 590-A, the 2026 IRS annual contribution limit is $7,000 (or $8,000 if you are age 50 or older) so contributing $583 per month gets you to the full limit. These results are estimates; actual growth depends on market performance and your individual tax situation.",
    howItWorks:
...

  {
    ...
    introText:
      "Dividend reinvestment (DRIP) means automatically using the dividends your investments pay to buy more shares rather than taking the cash. Over time, the compounding effect can meaningfully accelerate long-term portfolio growth.\n\nTo project a portfolio's total return, use the calculator above and enter a starting balance, an assumed annual return that combines price appreciation and dividend yield, and a time horizon. The heart of the DRIP story is the difference between a total-return projection, with dividends reinvested, and a price-only projection.",
    howItWorks:
...

  {
    ...
    introText:
      "Since 1926, the S&P 500 has delivered average annual nominal returns of approximately 10 to 11%, with dividends reinvested, according to S&P Dow Jones Indices SPIVA data and Federal Reserve historical records. Use the calculator above to see what a lump sum and regular monthly contributions would grow to at that historical rate over your chosen time horizon. The 10.5% preset reflects the long-run average, but any given decade can look dramatically different, including negative stretches that last several years.",
    howItWorks:
...

  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "It depends on your withdrawal rate and portfolio return. At a 4% withdrawal rate ($40,000 per year, or about $3,333 per month) with a 6% average return, a $1 million portfolio can last 30+ years. At a 6% withdrawal rate ($60,000 per year), the same portfolio may deplete in roughly 24 years. Use the calculator above to model your specific numbers. For what counts as enough to retire on in the first place, see our [am I ready to retire](/guides/am-i-ready-to-retire/) guide.",
      },
      {
        question: "How long will $3 million last in retirement?",
        answer:
...

  {
    ...
    introText:
      "This calculator works backward from a normal withdrawal projection. Instead of guessing a monthly amount and seeing how long your money lasts, enter your balance, expected annual return, and the number of years the money needs to last. The calculator above then gives you the exact flat monthly withdrawal that brings your balance to zero right on schedule, not early and with no money left unspent.",
    howItWorks:
  ...
  // page type: explainer/spoke (1200-word floor); teeup-exempt (opening sentence is already a direct-answer claim).
  {
    ...
    h1: "TSP Calculator",
    introText:
      "A TSP calculator shows how a Thrift Savings Plan (TSP) balance can grow over time. It uses the same compound-growth math as a 401(k) or IRA projection, with the government's automatic and matching contributions added on top. The TSP is the federal government's retirement savings plan for federal employees and uniformed service members, and it is built similarly to a private-sector 401(k). In the calculator above, enter your starting balance, your own monthly contribution, your expected annual return, and your time horizon. Then check the match formula below to see how much extra your agency or service adds to what you contribute.",
    howItWorks:
  ...
  // ── Competitor monitor pass 2026-09-11 ──
  {
    ...
    islandId: "annualized-return",
    toolHeading: "Find your true annual return",
    toolSubheading: "Enter a starting value, an ending value, and the years between them.",
