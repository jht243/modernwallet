...
export const INVESTING_SPOKES: SpokeEntry[] = [
...

  {
    ...
    commonMistakes: [
      ...
      "Forgetting that the limit applies across all IRAs combined. Your $7,500 cap is shared between traditional and Roth IRAs — you cannot put $7,500 into each.",
    ...
    workedExample:
      "Suppose you open a Roth IRA at age 35 with $10,000 already saved and contribute $583 per month (about $7,000 a year) for 30 years, earning an average of 7% annually. By age 65 the calculator projects a balance of approximately $730,000. Your total out-of-pocket contributions over that period are about $219,800. The remaining $510,000-plus is tax-free compounded growth — income you will never owe federal tax on in retirement, unlike a traditional IRA or 401(k), where every dollar withdrawn is taxable.",
    faqs: [
      {
        question: "What is the Roth IRA contribution limit for 2026?",
        answer:
          "The 2026 Roth IRA contribution limit is $7,500, or $8,600 if you are age 50 or older, up from $7,000 ($8,000 with catch-up) in 2025. The IRS adjusts limits for inflation periodically, so check IRS.gov each year for the current figure.",
      },
      {
        question: "What is the Roth IRA income limit?",
        answer:
          "For 2026, single filers start losing the ability to contribute at $153,000 of modified adjusted gross income and are fully phased out at $168,000. Married filing jointly phase-out runs $242,000–$252,000. The IRS updates these thresholds annually. If you exceed the limit, look into a backdoor Roth conversion.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Four differences matter most. (1) Tax timing: Roth contributions are after-tax — no deduction now, but withdrawals are forever tax-free. Traditional contributions may be tax-deductible now, but every withdrawal is taxed as ordinary income. (2) Required minimum distributions: Roth IRAs have no RMDs during the owner's lifetime; Traditional IRAs require withdrawals starting at age 73. (3) Income limits: Roth IRA has income limits ($168,000 single / $252,000 married in 2026); Traditional IRA has no income limit to contribute, though the deduction phases out for high earners with a workplace plan. (4) Withdrawal flexibility: Roth contributions (not earnings) can be withdrawn anytime without penalty — Traditional IRA withdrawals before 59½ trigger a 10% penalty. For a full comparison, see [401(k) vs Roth IRA](/compare/401k-vs-roth-ira/).",
      },
      {
        question: "Can a kid or teenager have a Roth IRA?",
        answer:
          "Yes, but only if they have earned income from actual work, like a part-time job or self-employment — a minor with no job income cannot have a Roth IRA funded on their behalf. A minor can contribute up to whichever is lower: the standard $7,500 annual limit or their total earned income for the year. A parent or guardian manages a custodial Roth IRA until the child reaches the age of majority in their state. See our [custodial accounts guide](/guides/custodial-savings-and-investing-accounts/) for the full rules.",
      },
      {
        question: "Can I roll a Roth IRA into a 401(k), or vice versa?",
        answer:
          "A Roth 401(k) can generally be rolled into a Roth IRA tax-free, and this is a common move when you leave a job. A Roth IRA, however, cannot be rolled into a pre-tax 401(k) — the tax treatment doesn't match, since a 401(k) rollover-in typically must come from pre-tax or other qualified-plan money. If your employer's plan accepts Roth rollovers specifically, ask your plan administrator to confirm before initiating a transfer.",
      },
    ],
    sources: [
...

  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes, and those are ideal DCA vehicles. Contributing to a 401(k) every paycheck is already dollar cost averaging by design. A Roth IRA lets you spread contributions across the year up to the annual limit ($7,500 in 2026). Both accounts shelter your DCA gains from annual taxes, unlike a taxable brokerage account.",
      },
    ],
    sources: [
