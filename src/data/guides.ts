  ...
  // -- podcast-pain-pass 2026-07-21: pay-off-debt-or-invest --
{
...

  {
    ...
    sections: [
      ...
      { heading: "Three sample allocations by risk level", body: "A conservative allocation for a shorter timeline or lower risk tolerance might run 30% stocks, 50% bonds, 20% cash — using the model long-run assumptions of roughly 10% for stocks, 4% for bonds, and 2.5% for cash used throughout our [portfolio calculators](/portfolio/), this blend targets a lower but steadier return with less volatility.\n\nA moderate allocation, often called a 60/40 portfolio, splits roughly 60% stocks and 40% bonds, balancing growth against a real cushion in a downturn — see our [60/40 portfolio calculator](/portfolio/60-40-portfolio-calculator/) to model this exact split. A growth-oriented allocation for a longer timeline might run 85% to 90% stocks (a mix of U.S. and international index funds) and 10% to 15% bonds, prioritizing long-run growth and accepting more short-term swings in exchange." },
