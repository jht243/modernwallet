...
export const GUIDES: Guide[] = [
...

  {
    ...
    sections: [
      ...
      { heading: "Do you specifically need an advisor for your 401(k)?", body: "A dedicated advisor is often overkill for a straightforward 401(k) invested in a single target-date fund, since that fund already handles diversification and rebalancing automatically for a fee far lower than most advisors charge. Many retirement savers do fine for decades without ever paying for advice, as long as they contribute consistently and don't try to time the market with their allocation.\n\nAn advisor tends to earn their fee back when your situation gets more complex: you're consolidating several old 401(k)s from past jobs, your employer's stock makes up a large share of your balance and you need a plan to diversify out of it, or you're within five to ten years of retirement and need to sequence withdrawals across taxable, tax-deferred, and Roth accounts. The value isn't in picking better funds, since index funds are hard to beat — it's in the planning decisions around the account.\n\nWeigh the fee honestly before you hire anyone. A 1% annual advisory fee on a $300,000 balance is $3,000 a year, compounding as a drag on your balance for as long as you hold the relationship. That fee is easy to justify if it prevents one costly mistake, like an early withdrawal penalty or a poorly timed Roth conversion, but harder to justify if all you get is generic fund picks you could have chosen yourself in an hour with our [401k calculator](/retirement/401k-calculator/)." },
    ],
    tools: [
      { href: "/retirement/", label: "Retirement" },
      { href: "/retirement/401k-calculator/", label: "401(k) growth" },
    ...
    faqs: [
      ...
      { question: "Do I need a financial advisor for my 401(k)?", answer: "Not always. A simple 401(k) in a single target-date fund often does fine without paid advice, since the fund already handles diversification and rebalancing. An advisor adds the most value when you're consolidating old 401(k)s, holding concentrated employer stock, or sequencing withdrawals near retirement." },
    ],
    sources: [
  ...
  },
  {
    ...
    metaDescription:
      "What happens to a 401(k) when you die: spouse vs. non-spouse rules, the SECURE Act 10-year withdrawal window, and how inherited 401(k) money is taxed.",
    h1: "What Happens to Your 401(k) When You Die? A Beneficiary's Guide",
    cardBlurb: "Spouse vs. non-spouse rules, the 10-year withdrawal window, and how inherited 401(k) money is taxed.",
    intro:
      "A 401(k) passes directly to whoever you name as beneficiary on the account, not to whoever inherits under your will, because federal law lets retirement-plan beneficiary forms bypass probate entirely. Who that beneficiary is changes everything: a surviving spouse gets the most flexible options, while a non-spouse beneficiary today faces a hard 10-year deadline to empty the account under the SECURE Act. This guide walks through who inherits what, how the tax bill works, and the one paperwork mistake that trips up nearly every beneficiary.",
    sections: [
      { heading: "Step 1: Know that the beneficiary form — not your will — decides who inherits", body: "Your 401(k) passes to whoever you named on the plan's beneficiary designation form, no matter what your will says. Retirement accounts and life insurance are non-probate assets: they transfer by contract, so the beneficiary form always wins over a conflicting will or trust.\n\nFederal law adds a twist unique to 401(k)s and other [ERISA-covered](https://www.dol.gov/general/topic/retirement) workplace plans: if you're married, your spouse is automatically the beneficiary of your full balance unless they sign a written waiver consenting to someone else. An IRA has no such rule — you can name anyone on an IRA without your spouse's consent — which is why an outdated 401(k) beneficiary form is one of the most common estate-planning mistakes after a marriage, divorce, or new child." },
      { heading: "Step 2: If you're the spouse, you have the most options", body: "A surviving spouse who inherits a 401(k) gets choices no other beneficiary gets. You can roll the balance into your own IRA or 401(k) and treat it as if it were always yours, which resets required minimum distributions (RMDs) to your own age instead of your late spouse's. You can also keep it as an inherited account and delay withdrawals until the year your spouse would have reached the plan's RMD age.\n\nRolling the money into your own account is usually the stronger move if you're younger than your spouse was, since it lets the balance keep growing tax-deferred for longer before RMDs start. Run the numbers with our [retirement calculator](/retirement/) before you decide, since the right call depends on your own age and how soon you'll need the income." },
      { heading: "Step 3: If you're not the spouse, the 10-year rule usually applies", body: "Since the [SECURE Act](https://www.irs.gov/retirement-plans/retirement-plans-faqs-regarding-required-minimum-distributions) took effect in 2020, most non-spouse beneficiaries — adult children, siblings, friends — must empty an inherited 401(k) within 10 years of the account owner's death. You can withdraw on any schedule inside that window: nothing until year ten, steady annual withdrawals, or anything in between.\n\nThere's one catch the [IRS](https://www.irs.gov/retirement-plans/retirement-plans-faqs-regarding-required-minimum-distributions) finalized in 2024: if the original account owner had already started their own RMDs before dying, most beneficiaries subject to the 10-year rule must also take at least a minimum distribution in years one through nine, then empty the rest by the end of year ten. Check your specific situation with the plan administrator before choosing a withdrawal schedule.\n\nA smaller group — eligible designated beneficiaries — gets more time: a minor child of the account owner (until they reach adulthood, when the 10-year clock then starts), someone disabled or chronically ill, or a beneficiary who isn't more than 10 years younger than the original owner. These beneficiaries can generally stretch withdrawals over their own life expectancy instead of the 10-year window." },
      { heading: "Step 4: Understand the tax bill before you touch the money", body: "Money you withdraw from an inherited traditional 401(k) is taxed as ordinary income in the year you take it out, exactly as it would have been for the original owner. A Roth 401(k) works differently: qualified withdrawals come out tax-free, since the original owner already paid tax on the contributions.\n\nThe good news for every beneficiary is that the 10% early-withdrawal penalty never applies to inherited retirement accounts, no matter how young you or the original owner were. That penalty only exists to discourage an account owner from tapping their own retirement savings early, so it has no purpose once the money has passed to a beneficiary. Still, one large lump-sum withdrawal from a traditional 401(k) can push you into a higher tax bracket for that year, so spreading withdrawals across the 10-year window often keeps more money after taxes." },
      { heading: "Step 5: The paperwork most beneficiaries don't expect", body: "Claiming an inherited 401(k) is slower than most people assume. You'll typically submit a certified copy of the death certificate plus the plan's own claim form to the plan's recordkeeper — the company, such as Fidelity, Empower, or Vanguard, that actually administers the employer's 401(k) — and processing commonly takes four to eight weeks before the funds move.\n\nOnce approved, most non-spouse beneficiaries are better off rolling the inherited balance directly into an inherited IRA at a low-cost brokerage rather than leaving it in the old employer's plan. Employer 401(k) plans typically restrict you to that plan's limited fund lineup, while an inherited IRA opens up low-cost index funds and lets you manage the 10-year withdrawal schedule yourself. Ask the recordkeeper specifically for a trustee-to-trustee transfer, not a check made out to you, so the move isn't accidentally treated as a taxable distribution." },
      { heading: "Step 6: Update your own 401(k) beneficiary today", body: "The best time to fix a beneficiary form is now, before it becomes someone else's problem. Review your own 401(k) beneficiary designation after every major life event: marriage, divorce, a new child, or the death of a named beneficiary.\n\nName both a primary and a contingent (backup) beneficiary, since a contingent beneficiary only inherits if your primary has already died. If your estate plan is more complex — blended families, a special-needs dependent, or wanting to control how fast the money is spent — a conversation with an estate planning attorney is worth it before you fill out the form. See our [estate planning calculator](/estate-planning/) to check whether your broader plan needs updating too." },
    ],
    tools: [
      { href: "/retirement/", label: "Retirement" },
      { href: "/retirement/rmd-calculator/", label: "RMD" },
    ...
    faqs: [
      { question: "Does a 401(k) go through probate?", answer: "No. A 401(k) passes directly to the named beneficiary by contract, bypassing probate and overriding a conflicting will. This is true whether the beneficiary is a spouse, child, or anyone else named on the plan's beneficiary form." },
      { question: "What happens if I don't name a 401(k) beneficiary?", answer: "If no valid beneficiary is on file, most plans pay the balance to your estate, which then must go through probate before heirs receive it. That process is slower, more public, and often more expensive than a direct beneficiary payout." },
      { question: "How long does a non-spouse beneficiary have to withdraw an inherited 401(k)?", answer: "Most non-spouse beneficiaries must withdraw the entire balance within 10 years of the account owner's death under the SECURE Act. If the original owner had already begun required minimum distributions, the beneficiary generally must also take an RMD in years one through nine before emptying the account by year ten." },
      { question: "Is an inherited 401(k) taxable?", answer: "Withdrawals from an inherited traditional 401(k) are taxed as ordinary income to the beneficiary. Withdrawals from an inherited Roth 401(k) are generally tax-free. Neither is subject to the 10% early-withdrawal penalty, regardless of the beneficiary's age." },
      { question: "Can a spouse roll an inherited 401(k) into their own IRA?", answer: "Yes. A surviving spouse can roll an inherited 401(k) into their own IRA or 401(k) and treat it as their own account, which resets required minimum distributions to their own age. Non-spouse beneficiaries cannot do this — they must keep the money in an inherited account." },
      { question: "Do I need my spouse's consent to name someone else as my 401(k) beneficiary?", answer: "Yes, for a 401(k) and most other employer retirement plans. Federal law requires your spouse to sign a written waiver before you can name someone else as primary beneficiary of your full balance. This spousal-consent rule does not apply to IRAs, which is a common source of confusion." },
    ],
    sources: [
      { label: "IRS — Retirement Topics: Beneficiary", url: "https://www.irs.gov/retirement-plans/retirement-topics-beneficiary" },
      { label: "IRS — Retirement Plan and IRA Required Minimum Distributions FAQs", url: "https://www.irs.gov/retirement-plans/retirement-plans-faqs-regarding-required-minimum-distributions" },
      { label: "U.S. Department of Labor — Retirement Plans, Benefits and Savings", url: "https://www.dol.gov/general/topic/retirement" },
    ],
  },

  {
    slug: "medicare-extra-help-income-limits",
    title: "Medicare Extra Help Income Limits for 2026: Do You Qualify?",
    metaDescription:
      "Medicare Extra Help income and resource limits for 2026, who automatically qualifies, and how to apply for help paying Part D drug costs.",
    h1: "Medicare Extra Help Income Limits for 2026: Do You Qualify?",
    cardBlurb: "2026 income and resource limits for Medicare's Part D drug-cost subsidy, who qualifies automatically, and how to apply.",
    intro:
      "Medicare Extra Help — officially the Part D Low-Income Subsidy — pays some or all of your Medicare prescription drug premiums, deductibles, and copays if your income and savings fall under federal limits. For 2026, that generally means income of roughly $23,000 to $24,000 a year for an individual or $31,000 to $32,000 for a married couple, though the exact published figure varies slightly by source and a few states and situations raise the ceiling. This guide walks through the 2026 income and resource limits, who qualifies automatically without applying, and how to apply if you don't.",
    sections: [
      { heading: "What Medicare Extra Help actually pays for", body: "Medicare Extra Help covers most of the cost of a Medicare Part D prescription drug plan for people with limited income and savings. Depending on your income level, it can eliminate your Part D monthly premium entirely, cut your annual deductible, and cap what you pay per prescription at a small, fixed copay instead of the plan's normal cost-sharing.\n\nThe subsidy comes in two tiers. Full Extra Help eliminates the premium and deductible and caps copays at a few dollars per prescription. Partial Extra Help, available at a slightly higher income, still reduces the premium and copays but by a smaller amount. The [Social Security Administration](https://www.ssa.gov/benefits/medicare/prescriptionhelp.html) runs the program jointly with Medicare and decides which tier you fall into based on your specific income and resources." },
      { heading: "The 2026 income limits", body: "Extra Help eligibility is built around 150% of the federal poverty level, a figure the Department of Health and Human Services adjusts every year. For 2026, that works out to roughly $23,000 to $24,000 a year in income for an individual and roughly $31,000 to $32,000 for a married couple living together — the exact published number rounds slightly differently across official sources, so check the current-year figure directly at ssa.gov before you assume you're over or under the line.\n\nIf you live in Alaska or Hawaii, your income limit is higher, since the federal poverty level itself is set higher for those states. If you're still working, Social Security also excludes a portion of your earned income from the calculation, which can qualify you even if your gross pay looks too high on paper. A dependent living with you who relies on your income can raise your limit too." },
      { heading: "The 2026 resource (asset) limits", body: "Beyond income, Extra Help also caps how much you can have in savings and other countable resources — about $18,090 for an individual and $36,100 for a married couple for 2026. Countable resources include bank accounts, stocks, bonds, and retirement accounts like IRAs.\n\nSeveral things do not count against this limit. Your home, one vehicle, personal belongings, and up to $1,500 per person set aside for burial expenses are all excluded. Life insurance policies with no cash value are excluded too, which surprises many applicants who assumed a policy would count against them." },
      { heading: "Who qualifies automatically — no application needed", body: "Some people never have to apply for Extra Help because Social Security and Medicare enroll them automatically. You qualify automatically if you have both Medicare and full Medicaid coverage, if you receive Supplemental Security Income (SSI), or if you're enrolled in a Medicare Savings Program that helps pay your Part B premium.\n\nIf you're automatically enrolled, Medicare mails you a notice confirming your Extra Help and the specific copay amounts you'll pay at the pharmacy. Keep that notice; pharmacies sometimes ask to see it if their system hasn't yet updated with your subsidy status." },
      { heading: "How to apply if you don't qualify automatically", body: "If you're not automatically enrolled but think you fall under the income and resource limits, apply directly through the [Social Security Administration](https://www.ssa.gov/benefits/medicare/prescriptionhelp.html), either online, by phone, or at a local Social Security office. The application asks about your income, resources, and household size, and Social Security typically responds with a decision within about a month.\n\nMany states also run a companion program, the Medicare Savings Program, which can pick up your Part B premium in addition to Extra Help's drug-cost savings. It's worth applying for both at the same time through your state Medicaid office, since the two programs use similar, but not identical, income tests." },
      { heading: "What happens after you're approved", body: "Once approved, you can use Extra Help with any Medicare Part D plan or Medicare Advantage plan that includes drug coverage — it isn't tied to one specific insurer. If your current plan's premium is above what Extra Help covers, you may still owe a small difference unless you switch to a plan Extra Help covers in full.\n\nExtra Help also opens a special enrollment period, letting you change Part D or Medicare Advantage plans once per calendar quarter for the first nine months of the year, instead of waiting for the fall open enrollment window. Use that flexibility if your current plan doesn't cover your specific medications well." },
    ],
    tools: [
      { href: "/elder-care/", label: "Elder care" },
      { href: "/elder-care/long-term-care-cost-calculator/", label: "Long-term care cost" },
      { href: "/retirement/", label: "Retirement" },
    ],
    faqs: [
      { question: "What income qualifies for Medicare Extra Help in 2026?", answer: "For 2026, Extra Help generally requires income under roughly $23,000 to $24,000 a year for an individual, or $31,000 to $32,000 for a married couple, plus resources under about $18,090 (individual) or $36,100 (couple). Check ssa.gov for the exact current-year figures, since they're adjusted annually and vary slightly by household situation." },
      { question: "Do I automatically get Medicare Extra Help?", answer: "Yes, if you already have full Medicaid, receive Supplemental Security Income, or are enrolled in a Medicare Savings Program. Social Security enrolls these groups automatically and mails a confirmation notice — you never need to file a separate Extra Help application." },
      { question: "What does Medicare Extra Help cover?", answer: "Extra Help reduces or eliminates your Medicare Part D premium and deductible and caps your copay on each prescription at a small, fixed amount. The exact savings depend on whether you qualify for full or partial Extra Help." },
      { question: "Does my house or car count against the Extra Help resource limit?", answer: "No. Your primary home, one vehicle, personal belongings, and up to $1,500 per person set aside for burial costs are all excluded from the resource limit. Only countable resources like bank accounts, stocks, bonds, and retirement accounts count." },
      { question: "How do I apply for Medicare Extra Help?", answer: "Apply through the Social Security Administration online, by phone, or at a local office. You'll report your income, resources, and household size, and Social Security typically issues a decision within about a month." },
      { question: "Can I change my Part D plan after getting Extra Help?", answer: "Yes. Extra Help gives you a special enrollment period to switch Medicare Part D or Medicare Advantage drug plans once per quarter during the first nine months of the year, in addition to the standard fall open enrollment period." },
    ],
    sources: [
      { label: "Social Security Administration — Extra Help With Medicare Prescription Drug Costs", url: "https://www.ssa.gov/benefits/medicare/prescriptionhelp.html" },
      { label: "Medicare.gov — Get Help With Drug Costs", url: "https://www.medicare.gov/basics/costs/help/drug-costs" },
      { label: "Medicare.gov — Medicare Savings Programs", url: "https://www.medicare.gov/basics/costs/help/medicare-savings-programs" },
    ],
  },

  {
    slug: "who-is-exempt-from-federal-income-tax",
    title: "Who Is Exempt From Federal Income Tax? A Complete Guide",
    metaDescription:
      "Who is exempt from federal income tax: low-income filers under the standard deduction, tax-exempt organizations, and claiming Exempt on your W-4.",
    h1: "Who Is Exempt From Federal Income Tax? A Complete Guide",
    cardBlurb: "Low-income filing thresholds, tax-exempt organizations, and how claiming 'Exempt' on your W-4 actually works.",
    intro:
      "Being exempt from federal income tax usually means one of three different things, and mixing them up causes real filing mistakes. It can mean your income is low enough that you owe no tax and may not even need to file. It can mean you work for a qualifying nonprofit or religious organization that itself pays no federal income tax. Or it can mean you checked 'Exempt' on your Form W-4 so your employer withholds nothing from your paycheck. This guide covers all three, plus the specific income types the [IRS](https://www.irs.gov/newsroom/irs-releases-tax-inflation-adjustments-for-tax-year-2026-including-amendments-from-the-one-big-beautiful-bill) never taxes at all.",
    sections: [
      { heading: "You don't owe tax if your income is under the standard deduction", body: "The simplest form of tax exemption is just not earning enough to owe anything. If your total income for the year is below your standard deduction, you generally owe zero federal income tax, because the standard deduction wipes out your taxable income entirely. For 2026, the IRS sets the standard deduction at $16,100 for single filers, $32,200 for married couples filing jointly, and $24,150 for heads of household.\n\nBeing under that threshold doesn't always mean you're excused from filing, though. Self-employed people who earn $400 or more still must file and pay self-employment tax even if their income tax bill is zero, since self-employment tax is a separate calculation from income tax. Filing can also be worth it even when it's not required, since it's the only way to claim a refund of taxes your employer withheld or to collect refundable credits like the Earned Income Tax Credit." },
      { heading: "Certain income types are never taxed, no matter how much you earn", body: "Some income is exempt by its nature, regardless of your total earnings. Interest from municipal bonds issued by a state or local government is generally exempt from federal income tax, which is why investors call them 'munis.' Life insurance death benefits paid to a beneficiary are also exempt in almost all cases, as are most gifts and inheritances you receive, though the estate itself may owe estate tax above a high threshold.\n\nQualified withdrawals from a Roth IRA or an [HSA](/compare/hsa-vs-fsa/) used for medical expenses are also tax-free, since those accounts are structured specifically to reward long-term, tax-advantaged saving. Combat pay for military members serving in a designated combat zone is excluded from taxable income as well. None of these require you to be otherwise 'exempt' — they're simply excluded from taxable income by law, no matter your income level." },
      { heading: "Nonprofits and religious organizations can be exempt as entities", body: "A tax-exempt organization is a different concept entirely — it's the organization itself, not an individual, that owes no federal income tax on its activities. The most common category is the 501(c)(3) public charity or private foundation, named for the [Internal Revenue Code section](https://www.irs.gov/charities-non-profits/exempt-organization-types) that grants the exemption, but 501(c) covers dozens of other exempt categories, including social welfare groups, labor unions, and business leagues.\n\nDonations to most 501(c)(3) organizations are tax-deductible for the donor, a separate benefit from the organization's own exemption. Churches and certain religious organizations are automatically treated as tax-exempt without needing to apply, though many still choose to file for formal recognition to reassure donors. Employees of a tax-exempt organization still owe personal income tax on their own wages — the organization's exemption does not extend to its staff." },
      { heading: "Conscientious religious objectors have a narrow, specific exemption", body: "A small group can exempt themselves from a specific tax, not income tax broadly, on religious grounds. Members of certain recognized religious sects, most commonly Old Order Amish and Old Order Mennonite communities, can apply for exemption from Social Security and Medicare self-employment tax by filing IRS Form 4029, based on a religious objection to accepting public insurance benefits.\n\nThis exemption is frequently confused with a broader 'religious exemption from income tax,' which does not exist. Approved filers still owe regular federal income tax on their earnings; only the self-employment tax portion is exempted, and only after formal IRS approval, not merely by self-declaration." },
      { heading: "Foreign workers and nonresident aliens follow different rules", body: "Nonresident aliens are taxed only on their U.S.-source income, and tax treaties between the U.S. and many countries can exempt specific categories of that income entirely, such as a visiting professor's teaching income or a student's scholarship. The exact exemption depends on the treaty language for that specific country, so a nonresident taxpayer needs to check the relevant treaty rather than assume general U.S. rules apply.\n\nA foreign diplomat or consular officer working in the U.S. under diplomatic status is also generally exempt from U.S. income tax on their official salary, under international agreements the U.S. has signed. This exemption does not extend to a diplomat's outside income from U.S. investments or a second job." },
      { heading: "Claiming 'Exempt' on your W-4 is about withholding, not owing", body: "Checking 'Exempt' on Form W-4 tells your employer to withhold zero federal income tax from your paycheck. This is legal only if you had no federal income tax liability last year and expect none this year — it is not a general option for anyone who wants a bigger paycheck.\n\nClaiming Exempt when you don't actually qualify is a common, costly mistake. If your income turns out to be taxable, you'll owe the full tax bill, and possibly a penalty, at filing time, since nothing was withheld along the way. An exempt claim on Form W-4 also expires every year — you must resubmit it by mid-February if you still qualify, or your employer will start withholding tax as if you're not exempt." },
    ],
    tools: [
    ...
    faqs: [
      { question: "How much can I earn before I owe federal income tax?", answer: "You generally owe no federal income tax if your total income stays under your standard deduction — for 2026, that's $16,100 for single filers, $32,200 for married couples filing jointly, and $24,150 for heads of household. Self-employed people may still owe self-employment tax even below these thresholds." },
      { question: "Is Social Security income exempt from federal tax?", answer: "Not entirely. Depending on your total income, up to 85% of your Social Security benefits can be taxable. Lower-income retirees whose only income is Social Security often owe no federal tax on it, but it isn't automatically exempt the way municipal bond interest is." },
      { question: "What organizations are exempt from federal income tax?", answer: "501(c)(3) charities, churches and other religious organizations, labor unions, and certain social welfare groups are the most common tax-exempt organizations. The exemption belongs to the organization, not its employees, who still owe personal income tax on their wages." },
      { question: "Can I claim Exempt on my W-4 to avoid withholding?", answer: "Only if you had zero federal tax liability last year and expect none this year. Claiming Exempt without meeting both conditions means you'll owe the full tax bill, and possibly a penalty, when you file, since nothing was withheld to cover it along the way." },
      { question: "Do religious groups have a special tax exemption?", answer: "Members of certain recognized religious sects, most commonly Old Order Amish and Mennonite communities, can apply for exemption from Social Security and Medicare self-employment tax using IRS Form 4029. This does not exempt them from regular federal income tax on their earnings." },
      { question: "Are nonresident aliens exempt from U.S. income tax?", answer: "Not entirely. Nonresident aliens are taxed on their U.S.-source income, but a tax treaty between the U.S. and their home country can exempt specific categories, like certain teaching income or scholarships. The exemption depends on the exact treaty language for that country." },
    ],
    sources: [
      { label: "IRS — 2026 Tax Inflation Adjustments", url: "https://www.irs.gov/newsroom/irs-releases-tax-inflation-adjustments-for-tax-year-2026-including-amendments-from-the-one-big-beautiful-bill" },
      { label: "IRS — Exempt Organization Types", url: "https://www.irs.gov/charities-non-profits/exempt-organization-types" },
      { label: "IRS — About Form 4029", url: "https://www.irs.gov/forms-pubs/about-form-4029" },
    ],
  },

  {
    slug: "how-to-choose-a-small-business-tax-service",
    title: "How to Choose a Small Business Tax Service in 2026",
    metaDescription:
      "How to choose a small business tax service: CPA vs. enrolled agent vs. full-service firm vs. DIY software, plus credentials to verify and red flags.",
    h1: "How to Choose a Small Business Tax Service",
    cardBlurb: "CPA vs. enrolled agent vs. full-service firm vs. DIY software — how to pick, vet, and avoid the wrong hire.",
    intro:
      "The right small business tax service depends on how complex your business is, not on who has the flashiest ad. A sole proprietor with simple books may do fine with DIY software, while a business with employees, inventory, or multiple states almost always needs a credentialed professional. This guide breaks down the four main types of tax help, the signs you've outgrown do-it-yourself software, and the exact questions and credential checks to run before you hire anyone.",
    sections: [
      { heading: "Signs you've outgrown DIY tax software", body: "DIY tax software works well for a simple, one-person business with straightforward income and few deductions. You've likely outgrown it once you hire your first employee or contractor, since payroll tax filings and 1099 reporting add compliance risk that software alone won't catch.\n\nOther signals include holding inventory, which requires cost-of-goods-sold accounting, operating in more than one state, forming an LLC or S-corp partway through the year, or simply spending more hours fighting the software than running your business. If a mistake could trigger a real [IRS](https://www.irs.gov/tax-professionals/choosing-a-tax-professional) notice or penalty, that's usually the point where paying a professional starts to pay for itself." },
      { heading: "The four types of small business tax services", body: "A full-service accounting firm handles bookkeeping, payroll, and tax filing under one roof, which suits a growing business that wants everything coordinated by one team. It typically costs the most but reduces the risk of a handoff error between separate bookkeeping and tax providers.\n\nA CPA (certified public accountant) is licensed by a state board and brings the broadest training in accounting and financial statements, making a CPA a strong fit when your tax question is really a bookkeeping or business-structure question in disguise. An enrolled agent (EA) is licensed by the IRS specifically, not a state, and specializes in tax preparation and IRS representation — EAs often charge less than CPAs for straightforward business tax filing since their training is narrower and IRS-focused. DIY and assisted tax software remains the cheapest option and can still work well for a simple single-member LLC with no employees and clean records." },
      { heading: "How to choose between them", body: "Start by matching the service to your complexity, not your budget alone. A simple, no-employee business with clean books can often stay on assisted software. A business with payroll, multiple owners, or a recent entity change usually needs at least an enrolled agent, and a business juggling investors, multiple states, or messy books benefits most from a full-service firm or CPA.\n\nCost is a real factor, but the cheapest option isn't always cheapest overall. A missed payroll tax deposit or a misclassified worker can trigger penalties that dwarf a year of professional fees. Weigh a provider's cost against the cost of the mistake they'd likely catch." },
      { heading: "Questions to ask before you hire", body: "Ask every candidate the same short list. Are you a CPA, enrolled agent, or neither, and can you represent me directly if the IRS sends a notice? How many businesses like mine do you currently work with? What's included in your fee, and what costs extra, such as a corrected return, a bookkeeping cleanup, or an audit response?\n\nAlso ask who will actually do the work. Some firms route routine returns to a junior preparer while a partner reviews only the summary, which can be fine for a simple return but matters more for a complex one. Get the fee and scope in writing before you hand over any documents." },
      { heading: "Red flags to watch for", body: "Walk away from anyone who guarantees a specific refund amount before seeing your full financial picture, since a legitimate preparer can't know the outcome until they've reviewed your actual numbers. Also be wary of a preparer who bases their fee on a percentage of your refund, which the IRS specifically warns creates an incentive to inflate deductions improperly.\n\nA preparer who won't sign the return, won't provide their Preparer Tax Identification Number (PTIN), or asks you to sign a blank or incomplete form is a serious warning sign — the IRS requires every paid preparer to sign returns they prepare and to include their PTIN. If a firm won't put its fee structure or scope of work in writing, treat that as a red flag too, not a minor inconvenience." },
      { heading: "How to verify credentials before you sign anything", body: "Verify a CPA's license directly through their state's board of accountancy, which is typically searchable online and shows whether the license is active and in good standing. Verify an enrolled agent using the [IRS's own directory of enrolled agents](https://www.irs.gov/tax-professionals/enrolled-agents), which confirms the credential is current.\n\nFor any paid preparer, you can also search the IRS's public directory of credentialed preparers, which lists CPAs, EAs, and attorneys with a valid PTIN. If your situation involves a serious IRS dispute rather than routine filing, compare your options against our [tax attorney vs. CPA vs. enrolled agent](/compare/tax-attorney-vs-cpa-vs-enrolled-agent/) breakdown to see which credential fits a collections or audit problem specifically." },
    ],
    tools: [
      { href: "/tax-resolution/", label: "Tax resolution" },
    ...
    faqs: [
      { question: "When should a small business switch from DIY tax software to a professional?", answer: "Switch once you hire your first employee or contractor, hold inventory, operate in more than one state, or change your business structure mid-year. Any of these adds compliance risk that software alone typically won't catch, and a mistake can cost far more than a preparer's fee." },
      { question: "What's the difference between a CPA and an enrolled agent for business taxes?", answer: "A CPA is licensed by a state board and has the broadest training in accounting and financial statements, which helps when a tax problem is tied to your bookkeeping. An enrolled agent is licensed by the IRS specifically, focuses on tax preparation and IRS representation, and often charges less for straightforward business filing." },
      { question: "How much does a small business tax service cost?", answer: "Cost varies widely by complexity and provider type: DIY software is the cheapest, an enrolled agent is often less expensive than a CPA for routine filing, and a full-service accounting firm that bundles bookkeeping and payroll typically costs the most. Get a written quote before you commit, since fees can shift once a provider sees your actual books." },
      { question: "Is it a red flag if a tax preparer bases their fee on my refund?", answer: "Yes. The IRS specifically warns against preparers who charge a percentage of the refund, since it creates an incentive to inflate deductions or credits improperly. A legitimate preparer charges a flat fee, an hourly rate, or a fee based on the return's complexity, never a cut of your refund." },
      { question: "How do I verify a tax preparer's credentials?", answer: "Verify a CPA through their state board of accountancy's online license lookup, and verify an enrolled agent through the IRS's enrolled agent directory. Every paid preparer must also have a valid Preparer Tax Identification Number (PTIN) and must sign any return they prepare." },
      { question: "Do I need a tax attorney instead of a CPA or enrolled agent?", answer: "Only if you're facing a serious IRS dispute, such as criminal exposure, a Tax Court case, or a complex appeal, rather than routine filing. For standard small business tax preparation, a CPA or enrolled agent is usually the right and more affordable choice." },
    ],
    sources: [
      { label: "IRS — Choosing a Tax Professional", url: "https://www.irs.gov/tax-professionals/choosing-a-tax-professional" },
      { label: "IRS — Enrolled Agents", url: "https://www.irs.gov/tax-professionals/enrolled-agents" },
      { label: "IRS — Directory of Federal Tax Return Preparers", url: "https://irs.treasury.gov/rpo/rpo.jsf" },
    ],
  },

  {
    slug: "credit-score-for-0-apr-credit-card",
    title: "What Credit Score Do You Need for a 0% APR Credit Card?",
    metaDescription:
      "What credit score you need for a 0% APR credit card, how issuers really decide, and how to raise your approval odds before you apply.",
    h1: "What Credit Score Do You Need for a 0% APR Credit Card?",
    cardBlurb: "The score tiers issuers look for, what else affects approval, and how to check your odds before you apply.",
    intro:
      "Most 0% APR credit cards are built for applicants with good to excellent credit, generally a [FICO](https://www.myfico.com/credit-education/credit-scores) score of 670 or higher, and the longest 0% offers typically go to applicants closer to 740 and above. Your credit score is only part of the decision, though — issuers also weigh your income, existing debt, and recent credit activity before approving a 0% intro APR card. This guide breaks down the score tiers, what else matters, and how to check your approval odds without a hard inquiry on your credit report.",
    sections: [
      { heading: "The credit score tiers that matter", body: "Credit scoring models group scores into tiers, and where you land shapes which 0% APR offers you'll realistically qualify for. Under the widely used FICO scale, a score below 580 is considered poor, 580 to 669 is fair, 670 to 739 is good, 740 to 799 is very good, and 800 to 850 is exceptional.\n\nMost 0% APR cards are marketed toward the 'good' tier and above, but the best offers, the longest 0% periods, often 18 to 21 months, tend to go to applicants in the 'very good' to 'exceptional' range. A score in the fair range can still get approved for a card, but usually not one with a 0% intro rate; that applicant is more likely to be offered a card with a lower limit and a standard interest rate instead." },
      { heading: "Your score alone doesn't decide approval", body: "Issuers evaluate far more than the three-digit number when they decide on a 0% APR application. Your income relative to your existing debt matters, since a card issuer wants evidence you can handle new available credit even if you never carry a balance. Your credit utilization, meaning how much of your existing credit limits you're currently using, matters too; a strong score paired with high utilization can still lead to a low limit or a decline.\n\nRecent credit activity also weighs heavily. Several new account openings or hard inquiries in the last six months can hurt your odds even with a good score, since issuers read a cluster of new accounts as a possible sign of financial stress. A single missed payment in the past 12 months can knock out an otherwise strong application, since on-time payment history is the single largest factor in most credit scoring models." },
      { heading: "How to check your odds before you apply", body: "Most major issuers offer a true pre-qualification or pre-approval tool that checks your basic eligibility with a soft inquiry, which does not affect your credit score. Run your information through a card's pre-qualification tool before submitting a full application, since a full application triggers a hard inquiry that can briefly lower your score whether or not you're approved.\n\nThe [Consumer Financial Protection Bureau](https://www.consumerfinance.gov/consumer-tools/credit-reports-and-scores/) also recommends pulling your free credit reports from all three bureaus at annualcreditreport.com before applying for any new credit, so you can catch and dispute errors that might be dragging your score down without your knowledge." },
      { heading: "What to do if your score isn't quite there yet", body: "If your score sits in the fair range, the fastest lever is usually your credit utilization: paying down existing balances to under 30% of your available limit, and ideally under 10%, can raise your score within one to two billing cycles once the lower balance is reported. Requesting a credit limit increase on an existing card you keep at a low balance can also lower your utilization ratio without any new debt.\n\nA secured credit card or a credit-builder loan can help build a thin credit file over several months if you have little credit history at all, rather than a longer history with poor management. Whatever the cause, check your specific score tier against a target card's typical approval range before applying, since a decline still shows up as a hard inquiry even though it added nothing to your available credit." },
      { heading: "Why a 0% APR card is only worth it with a plan", body: "A 0% intro APR is a temporary window, not a permanent rate, and it typically lasts a fixed number of months before reverting to the card's standard purchase or balance-transfer APR. Any balance left on the card after that window accrues interest at the regular rate, which can be well above 20%, so the intro period is only valuable if you have a real plan to pay off the balance before it ends.\n\nDivide your planned balance by the number of 0% months to get the flat payment you need to make each month to hit zero right before the intro rate expires. Missing even one payment during the intro period can trigger the loss of the 0% rate entirely on some cards, so set up autopay for at least the minimum before you carry any balance." },
    ],
    tools: [
    ...
    faqs: [
      { question: "What credit score do I need for a 0% APR credit card?", answer: "Most 0% APR cards target applicants with a FICO score of 670 or higher, and the longest 0% offers (18 to 21 months) typically go to applicants in the 740-and-above range. A lower score can still get you approved for a card, but usually not one with a 0% intro rate." },
      { question: "Can I get a 0% APR card with fair credit?", answer: "It's possible but unlikely for the best offers. Fair credit, roughly 580 to 669, more often qualifies for a card with a standard interest rate and a lower limit rather than a 0% intro APR, since issuers reserve their best 0% offers for lower-risk, higher-score applicants." },
      { question: "Does checking my 0% APR approval odds hurt my credit score?", answer: "Not if you use a true pre-qualification tool, which relies on a soft inquiry that doesn't affect your score. A full application, on the other hand, triggers a hard inquiry that can briefly lower your score, whether or not you're approved." },
      { question: "What matters besides my credit score for 0% APR approval?", answer: "Issuers also weigh your income relative to existing debt, your current credit utilization, and how many new accounts or hard inquiries you've had recently. A strong score with high utilization or several recent inquiries can still lead to a decline or a lower limit." },
      { question: "How long do 0% APR offers usually last?", answer: "Most 0% intro APR offers run for a fixed period, commonly 12 to 21 months, after which the rate reverts to the card's standard APR. Any balance you haven't paid off by the end of that window starts accruing interest at the regular rate." },
      { question: "How can I raise my credit score before applying for a 0% APR card?", answer: "The fastest lever is usually lowering your credit utilization by paying down existing balances to under 30%, and ideally under 10%, of your available limit. On-time payments and avoiding new hard inquiries in the months before you apply also help." },
    ],
    sources: [
      ...
      { label: "AnnualCreditReport.com — Official Free Credit Reports", url: "https://www.annualcreditreport.com/" },
    ],
  },
  ...BUSINESS_GUIDES,
];
