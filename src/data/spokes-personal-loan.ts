...
export const PERSONAL_LOAN_SPOKES: SpokeEntry[] = [
  {
    ...
    introText:
      "A personal loan extra payment calculator shows how much sooner you can clear your loan (and how much interest you can skip) by adding even a small amount to your normal monthly payment. Enter your remaining balance, rate, and term above, then add an extra monthly amount or switch to choosing a payoff date. The calculator will show your new timeline next to the original one. Extra payments work because a personal loan charges interest only on what you still owe. Every extra dollar you put toward principal now stops earning the lender interest in every month that follows.",
    howItWorks:
