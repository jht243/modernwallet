...
export const PORTFOLIO_SPOKES: SpokeEntry[] = [
...

  {
    ...
    faqs: [
      ...
      { question: "How long will $1,000,000 last using the 4% rule?", answer: "At a 4% initial withdrawal rate, $1,000,000 supports about $40,000 a year and has historically sustained roughly 30 years of retirement in most market scenarios. Our [how to retire with $1 million](/guides/how-to-retire-with-1-million/) guide covers that math in more depth, including the caveat that a longer retirement or heavier equity weighting can call for a lower, more conservative rate." },
      { question: "How many Americans have $1,000,000 in retirement?", answer: "There's no published figure specific to retirement-account balances alone. The closest public benchmark is the Federal Reserve's Survey of Consumer Finances, which puts the top-10% cutoff for total net worth, across all ages and asset types, at roughly $1.46 million. Retirement-account balances are only one part of that total figure, alongside home equity and other assets, so the true share of Americans with $1 million specifically inside retirement accounts is smaller and not something the SCF publishes as its own number. See the [net worth percentile calculator](/net-worth/net-worth-percentile-calculator/) for the full set of total-net-worth cutoffs." },
    ],
    sources: [
