...
export const PORTFOLIO_SPOKES: SpokeEntry[] = [
...

  {
    ...
    faqs: [
      ...
      { question: "How do I actually build a 60/40 portfolio myself?", answer: "You build a 60/40 portfolio by putting 60% of your money into one broad U.S. stock index fund and 40% into one broad bond index fund at any major brokerage, then rebalancing back to that split about once a year. Most investors hold a single total-stock-market fund for the stock side and a single total-bond-market fund for the bond side, which keeps the portfolio to two funds and the ongoing cost low. Once it's set up, check the split about once a year and rebalance back to 60/40 when it drifts; see [how and when to rebalance](/guides/portfolio-rebalancing/) for the tax-smart way to do it." },
    ],
    sources: [
