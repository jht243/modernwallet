...
export const COMPARISONS: ComparisonEntry[] = [
  ...
  // ─── 12. HSA vs FSA ──────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      {
        heading: "How to actually invest your HSA balance",
        content:
          "Most HSA administrators require you to keep a minimum cash balance, commonly $1,000 to $2,000 though it varies by provider, before you can invest anything above that threshold. Below the threshold, the money sits in a low-interest cash account; above it, you can typically choose from a curated list of mutual funds or, with some providers, a full self-directed brokerage window.\n\nThe cash-versus-invest decision comes down to whether you have other savings to cover near-term medical bills. If a separate emergency fund can cover your health plan's out-of-pocket maximum, investing everything above your provider's required minimum makes sense, since the money has decades to compound before you likely need it. If the HSA is your only cushion for medical costs, keep more in cash so a bad year doesn't force you to sell investments at a loss to pay a bill.\n\nMany employer-selected HSA administrators charge higher account fees and offer a thinner fund lineup than providers built specifically for self-directed investors. It's legal and common to open a separate HSA with a lower-cost provider and move your balance there through a trustee-to-trustee transfer, which has no limit on frequency and no tax consequence. That's different from a 60-day HSA rollover, which is limited to one per 12-month period — always request a direct transfer between providers, not a check made out to you, to avoid that limit and the risk of missing the 60-day window.\n\nOnce invested, treat the HSA like any other long-term account: rebalance back to your target mix roughly once a year so a strong stock run doesn't leave you more concentrated in equities than you intended.",
      },
      {
    ...
    faqs: [
      ...
      {
        question: "How do I invest my HSA money?",
        answer:
          "Once your balance is above your provider's required cash minimum (commonly $1,000 to $2,000), you can typically invest in a curated fund list or a self-directed brokerage window, depending on the administrator. If your employer's HSA has high fees or limited fund choices, you can transfer the balance to a lower-cost provider at any time with no tax consequence via a trustee-to-trustee transfer.",
      },
      {
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "Interest on either loan is only tax-deductible if you use the funds to buy, build, or substantially improve the home securing the loan. This rule comes from the Tax Cuts and Jobs Act and is spelled out in IRS Publication 936.\n\n\"Substantially improve\" means the project adds value, prolongs the home's life, or adapts it to a new use. Using the money for debt consolidation or personal expenses makes the interest nondeductible.\n\nThe deduction is capped at $750,000 of combined mortgage debt ($375,000 if married filing separately). You must also itemize to claim it, so many borrowers get no tax benefit at all.\n\nClaiming the deduction takes a specific paperwork trail, not just meeting the buy-build-improve rule. Your lender sends Form 1098 each January showing the total interest you paid; that figure goes on Schedule A of your federal return, added to your other itemized deductions. Because the standard deduction is large — $16,100 for single filers and $32,200 for married couples filing jointly for 2026 — many homeowners with a modest HELOC or home equity loan balance find their itemized total, interest included, still falls short of the standard deduction, meaning the interest technically qualifies but delivers no actual tax savings.\n\nIf you do itemize, keep records tracing exactly how you spent the borrowed funds: invoices from a contractor, a home improvement store receipt, or a closing statement showing the funds went toward the purchase. The IRS can ask you to substantiate the buy-build-improve use years after the fact, and mixing renovation funds with other spending in one account makes that trail much harder to prove.",
      },
      {
    ...
    faqs: [
      ...
      {
        question: "How do I actually claim the HELOC interest deduction on my taxes?",
        answer:
          "Your lender sends Form 1098 each January showing the interest you paid; you report that amount on Schedule A if you itemize. Keep receipts or invoices tracing the funds to home improvements, since the IRS can ask you to substantiate the buy-build-improve use years later.",
      },
    ],
    sources: [
