...
export const COMPARISONS: ComparisonEntry[] = [
  ...
  // ─── 11. ETF vs Mutual Fund ───────────────────────────────────────────────
  {
    ...
    faqs: [
      {
        question: "Do ETFs have hidden trading costs that mutual funds don't?",
        answer:
          "Yes, ETFs carry a bid-ask spread because they trade on an exchange throughout the day, which is a small hidden cost every time you buy or sell. A mutual fund is priced once a day at its net asset value, so you avoid the spread, though you may face other costs like a redemption fee.",
      },
      {
        question: "Can a mutual fund charge me a fee for selling too soon?",
        answer:
          "Yes, some mutual funds charge a short-term redemption fee if you sell shares within a set period after buying, often to discourage rapid trading that raises costs for other shareholders. ETFs don't have this structural fee since you're simply selling shares on an exchange, though you still pay the bid-ask spread.",
      },
      {
  ...
  // ─── Trump Account vs 529 (mindmap pass 2026-07-04) ──────────────────────
  {
    ...
    sections: [
      ...
      { heading: "Which one applies to your child?", content: "Start with the Trump Account, because it reaches almost everyone. If your child is a U.S. citizen born between 2025 and 2028 with an SSN, they qualify regardless of income. That makes it the account most families can actually plan around, and the one you can add money to.\n\nBaby bonds depend on where you live and how much you earn. There is no federal baby bond you can sign up for today, because the federal version is still a proposal. A state baby bond only applies if your state runs one and your family meets its income rules. In Connecticut, for example, the birth generally must be covered by Medicaid.\n\nThese programs can also stack. A lower-income Connecticut family could have both a Trump Account and a state baby bond for the same child. If you want to compare tax-advantaged options for education specifically, see our [Trump Account vs 529](/compare/trump-account-vs-529/) breakdown. Ready to start? See [how to open a Trump Account](/guides/how-to-open-a-trump-account/) for the step-by-step process." }
    ],
    faqs: [
      { question: "Is the Trump Account's $1,000 seed the same amount in every state?", answer: "Yes, the $1,000 federal seed is the same nationwide for every eligible child, regardless of state. State baby-bond programs are separate and vary by state - for example, Connecticut's program invests up to $3,200 for eligible children, which is a different pot of money from the federal Trump Account seed." },
...

  {
    ...
    faqs: [
      { question: "Can I roll a 529 plan into a Trump Account, or the other way around?", answer: "No, there is no direct rollover between a 529 plan and a Trump Account; the two are separate account types with different rules. If you want to redirect money, the custodian would need to withdraw from one account, which can trigger taxes and penalties on a non-qualified 529 withdrawal, and then contribute to the other within its own contribution limits." },
      { question: "Does my child need to be a U.S. citizen to have a 529 plan the way they do for a Trump Account?", answer: "No, a 529 plan has no citizenship requirement for the beneficiary, so any child with a Social Security number or taxpayer ID can generally be named on one. A Trump Account is narrower: only U.S.-citizen children born between January 1, 2025, and December 31, 2028 qualify for the account, and only citizens born in that window get the $1,000 seed." },
...

  {
    ...
    faqs: [
      { question: "Is there a minimum age for a custodial Roth IRA?", answer: "No, there is no minimum age for a custodial Roth IRA. The only requirement is documented earned income, so a child of any age who has earned money from a job or self-employment can qualify." },
      { question: "What happens if I contribute more to a custodial Roth IRA than my child actually earned?", answer: "The excess is an over-contribution, and the IRS charges a 6% excise tax on the excess amount for every year it stays in the account. You can avoid the penalty by withdrawing the excess contribution and its earnings before your tax filing deadline, so keep documentation of earned income before you fund the account." },
  ...
  // ─── Custodial Roth IRA vs Brokerage Account (ga4-top-pages pass 2026-07-08) ──
  {
    ...
    faqs: [
      {
        question: "Can I move money from a custodial brokerage account into a custodial Roth IRA?",
        answer:
      ...
      {
        question: "What happens if I put more into a custodial Roth IRA than my child earned that year?",
        answer:
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "Ask one question: will you definitely leave this money invested until your child is 18?\n\nIf yes, and your child is seed-eligible, start with the Trump Account to capture the free $1,000 and tax-deferred growth. It's the strongest first dollar.\n\nIf you might need the money sooner, want investments beyond an index fund, or your child isn't seed-eligible, a taxable brokerage is the better fit. And you don't have to choose just one - claim the free Trump Account seed, then run a brokerage alongside it for the flexible, unlocked portion of your savings. Compare a fully liquid cash option in our [Trump Account vs savings account](/compare/trump-account-vs-savings-account/) breakdown, or see the parent-owned trade-offs in [brokerage vs IRA](/compare/brokerage-vs-ira/). Ready to claim the free seed? See [how to open a Trump Account](/guides/how-to-open-a-trump-account/) for the step-by-step process.",
      },
    ],
    faqs: [
      {
        question: "Is a Trump Account's $1,000 seed taxed when it's deposited?",
        answer: "No, the $1,000 federal seed is not taxed when it lands in the account. Like the rest of a Trump Account's growth, it sits tax-deferred until the child withdraws money after age 18, when the withdrawal is taxed as ordinary income the same way a traditional IRA distribution is.",
      },
      {
        question: "Does a Trump Account or a brokerage account count against my child's financial aid?",
        answer: "A Trump Account works like a retirement account and is not reported as an asset on the FAFSA, so it does not reduce financial aid. A brokerage account does count: if it's parent-owned it's assessed at up to 5.64% of its value, and if it's a custodial account owned by the child it's assessed at up to 20%, which hurts aid eligibility more.",
      },
      {
        question: "Can I lose money in a Trump Account?",
        answer: "Yes, because a Trump Account invests entirely in an S&P 500 index fund, its balance can fall during a market downturn - the index dropped roughly 19% in 2022. A taxable brokerage account carries the same market risk if it's invested in stocks, though you control which investments it holds.",
      },
      {
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "A kids savings account is the right home for short-term money. If you are saving for a bike, a summer trip, or a rainy-day fund your child can reach, the guaranteed value and instant access beat market risk.\n\nIt is also a great teaching tool. Kids can watch a savings balance grow and learn how interest works, without the swings of a stock fund. For growth money, though, the Trump account wins — and you can weigh other options in our [best investment account for kids](/guides/best-investment-account-for-kids/) guide, or compare it with a [brokerage account](/compare/trump-account-vs-brokerage-account/) or [custodial account](/compare/trump-account-vs-custodial-account/). Ready to claim the seed? See [how to open a Trump Account](/guides/how-to-open-a-trump-account/) for the steps."
      }
    ],
    faqs: [
      {
        question: "Does a Trump account or kids savings account count against financial aid?",
        answer: "A Trump account works like a retirement account, so it is not reported as an asset on the FAFSA and does not reduce aid. A kids savings account owned by the child counts as the student's own asset and can be assessed at up to 20% of its value, which lowers aid more than a parent-owned account would."
      },
      {
        question: "Who owns a kids savings account, me or my child?",
        answer: "Most kids savings accounts are opened as a joint or custodial account, with a parent or guardian as co-owner or custodian until the child is old enough to manage it alone. The exact age when full control transfers depends on the bank and the state, so check the account agreement when you open it."
      },
      {
  ...
  // -- podcast-pain-pass 2026-07-21: debt-snowball-vs-avalanche --
{
...

  {
    ...
    verdict:
      "Neither fund is better in the abstract, because they solve different problems. A target-date fund suits someone who wants to buy one fund, walk away, and trust the glide path to manage risk automatically as retirement gets closer; that convenience costs roughly 0.05 to 0.10 percentage points more per year than a plain S&P 500 fund at both [Vanguard](https://investor.vanguard.com) and [Fidelity](https://www.fidelity.com). An S&P 500 index fund suits someone who wants the lowest possible cost and is willing to add their own bond and international funds and rebalance that mix over time. If you're not sure you'll actually rebalance a DIY portfolio as you age, the target-date fund's automation is usually worth its small extra cost.",
    sections: [
      {
