  ...
  faqs: [
    {
      ...
      answer:
        "The business standard mileage rate for 2026 is 72.5 cents per mile for miles driven January 1 through June 30, and 76 cents per mile for miles driven July 1 through December 31. The IRS raised the rate mid-year. Medical and moving mileage is 20.5 cents in the first half and 23.5 cents in the second; the charitable rate stays at 14 cents, because it is fixed by statute rather than adjusted for inflation. This federal rate is a tax deduction, not an employer mandate — see our guide on [state mileage reimbursement laws](/guides/state-mileage-reimbursement-law-california-texas-michigan/) for California, Texas, and Michigan employer obligations, or [international mileage rates](/guides/mileage-reimbursement-rates-uk-canada-ireland-nz/) if you work outside the United States.",
    },
    {
