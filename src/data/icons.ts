...
const SPOKE_SHAPE: Record<string, string> = {
  ...
  "auto-loan/car-affordability-calculator": "wallet",
  "mortgage/home-affordability-calculator": "target",
  "mortgage/down-payment-calculator": "coins",
  "mortgage/closing-cost-calculator": "list",
