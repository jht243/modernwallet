...
export const CALCULATORS: CalculatorDef[] = [
  ...
  // Engine: src/lib/estate-planning-hub.ts. Island: EstatePlanningHubCalculator.
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "The single most common estate planning mistake is signing a revocable living trust and never actually retitling assets into it, which leaves the trust empty and forces probate anyway despite the money already spent. Three other mistakes show up almost as often:\n\n- Naming no guardian for minor children, which lets a court decide instead of the parents.\n- Assuming a will drafted in one state covers a move to another, when signing rules and any state estate tax differ by state.\n- Skipping the trust's funding checklist entirely rather than treating it as a required last step.\n\nSee our [living trust cost calculator](/estate-planning/living-trust-cost-calculator/) for that funding checklist.",
      },
    ],
    sources: [
...

  {
    ...
    faqs: [
      ...
      { question: "Does an adopted child qualify for a Trump Account the same as a biological child?", answer: "Yes, an adopted child qualifies for a Trump Account the same way a biological child does. The law's eligibility test looks at citizenship, birth year, and having a Social Security number, not at how the child joined the family. If the adoption finalizes after the child's 2025-2028 birth window, confirm the exact timing rule on the [IRS's Trump Accounts page](https://www.irs.gov/trumpaccounts) before assuming either way." },
    ],
    sources: [
