...
export const CALCULATORS: CalculatorDef[] = [
  ...
  // Engine: src/lib/tax-resolution-hub.ts. Island: TaxResolutionHubCalculator.
  {
    ...
    introText:
      "A tax resolution calculator matches your IRS debt with the specific relief program most likely to work: Offer in Compromise, installment agreement, Currently Not Collectible, penalty abatement, or Innocent Spouse Relief. The calculator above does this in seconds. Just enter how much you owe, your monthly income, your allowable living expenses, your net asset equity, and whether the debt is joint.\n\nFor example, if someone owes $42,000, has $700 a month in disposable income, and has $8,000 in equity, their IRS Reasonable Collection Potential is $16,400, the floor for a viable Offer in Compromise.",
    howItWorks:
  ...
  // Engine: src/lib/estate-planning-hub.ts. Island: EstatePlanningHubCalculator.
  {
    ...
    introText:
      "An estate planning calculator uses your family and asset situation to identify the specific documents you need, from a simple will to a full estate plan with irrevocable trusts. The calculator above gives you a recommendation in seconds based on six inputs: state, net worth, marital status, kids, cross-state property, and any special-needs dependents.\n\nFor a married couple with kids and $850,000 in net worth living in California, it recommends a will with guardianship nomination, durable powers of attorney, and healthcare directives. The attorney cost is $750 to $2,500, compared with $199 to $299 through online services like Trust & Will or LegalZoom.\n\nFor the full document checklist, help with the DIY-vs-attorney decision, and the right order to tackle everything, see our [first-time estate planning guide](/guides/first-time-estate-planning/).",
    howItWorks:
    ...
    faqs: [
      ...
      {
        question: "What are common mistakes to avoid in estate planning?",
        answer:
          "The single most common estate planning mistake is signing a revocable living trust and never actually retitling assets into it, which leaves the trust empty and forces probate anyway despite the money already spent. See our [living trust cost calculator](/estate-planning/living-trust-cost-calculator/) for the funding checklist that catches this specifically. A second common mistake is naming no guardian for minor children, which hands that decision to a court instead of the parents. Both mistakes are easy to avoid once you know to check for them, since neither requires redoing the plan itself, just finishing the last step.",
      },
    ],
    sources: [
  ...
  // small-estate thresholds. Engine: src/lib/probate-hub.ts.
  {
    ...
    introText:
      "A probate calculator estimates how much it will cost (and how long it will take) to probate an estate in your state. That includes attorney fees (statutory in 9 states and reasonable-fee in ~41), executor commission, court filing fees, and any ancillary probate required for out-of-state real property.\n\nWhere an actual state fee schedule exists, the calculator above applies it. California follows Cal. Prob. Code §10810, with 4%/3%/2%/1%/0.5% tiers. Florida follows Fla. Stat. §733.6171, with a $1,500 base plus tiered percentages. Another 7 states have their own statutes.\n\nFor a moderate California estate valued at $750,000, the total probate cost runs about $36,000 to $42,000 over 15 to 30 months. By comparison, a revocable living trust that would have avoided probate entirely costs $2,025 to $6,750.",
    howItWorks:
  ...
  // CareScout 2025 Cost of Care Survey. OBBBA (P.L. 119-21) caps home equity at $1M eff. 1/1/2028.
  {
    ...
    introText:
      "An elder care planning calculator uses your age, assets, income, and long-term care outlook to identify the specific planning steps that can protect assets from the median nursing home cost of $115,000 per year while preserving Medicaid eligibility.\n\nThe calculator above uses the 2026 federal figures: a Community Spouse Resource Allowance of $32,532-$162,660, an MMMNA minimum of $2,644, an institutional income cap of $2,982/month, and the 60-month lookback under 42 U.S.C. §1396p(c).\n\nFor a married couple, both age 62, with $550,000 in countable assets and possible LTC needs within 5 years, the recommendation is to fund a Medicaid Asset Protection Trust now, attorney-drafted for $3,000-$6,000. Every month of delay compresses the lookback window and shifts assets from protected to countable.",
    howItWorks:
...

  {
    ...
    faqs: [
      ...
      { question: "Does an adopted child qualify for a Trump Account the same as a biological child?", answer: "Yes, an adopted child qualifies for a Trump Account the same way a biological child does. The law's eligibility test looks only at citizenship, birth year, and having a Social Security number. If the adoption finalizes after the child's 2025-2028 birth window, confirm the exact timing rule on the [IRS's Trump Accounts page](https://www.irs.gov/trumpaccounts) before assuming either way." },
    ],
    sources: [
  ...
  // stays unrealized until you sell.
  {
    ...
    introText:
      "A taxable vs. tax-deferred calculator compares how much your money could grow in a regular brokerage account and a tax-deferred account, such as a traditional 401(k) or IRA, using the same starting balance, contributions, and return. Enter your numbers above to see the final balances side by side.\n\nFor example, if you start with $10,000 and add $6,000 a year for 25 years at a 7% return, taxed at 24%, the tax-deferred account ends up meaningfully larger than the taxable one, even though it owes a bigger one-time tax bill at the end.",
    howItWorks:
  ...
  // warning box every card statement must show under Regulation Z, 12 CFR 1026.7(b)(12).
  {
    ...
    introText:
      "A credit card payoff calculator shows how long it will take to clear a balance and how much interest you'll pay, based on your APR and monthly payment. Enter your balance and APR in the calculator above, along with either a monthly payment or a target payoff date.\n\nFor example, a $6,000 balance at 24% APR, paid at $250 a month, is paid off in 34 months and costs $2,255.61 in interest. The calculator also automatically shows the minimum-payment-only path. With the same balance and rate, making minimum payments alone takes 252 months (about 21 years) and costs $10,886.92 in interest. That's over $8,600 more than the $250-a-month plan for the same starting balance.",
    howItWorks:
  ...
  },
  {
    ...
    introText:
      "A PTO cash-out calculator converts unused paid time off, vacation, or leave days into a dollar amount. It calculates your daily pay rate, then multiplies that rate by the number of days you choose to sell back.\n\nEnter your salary or hourly rate, the number of leave days you have available, and how many you want to cash out. The calculator above will show your gross payout, an estimated net payout based on a simple flat tax-rate estimate, and what those same days would have been worth as paid time off instead.\n\nFor example, someone earning $72,000 a year on a standard five-day work week has a daily rate of about $276.92. Selling 5 days would produce a gross payout of about $1,384.62, or roughly $1,080 after a 22% tax-rate estimate.",
    howItWorks:
  ...
  },
  {
    ...
    h1: "IUL Calculator",
    introText:
      "This IUL calculator projects an indexed universal life (IUL) policy year by year, showing what the cap and the cost of insurance actually take out of it. Every guide we write here starts with the math. For an indexed universal life policy, that math turns on charges the sales illustration tends to leave in the footnotes, the same charges that fund the [commission an agent earns](/guides/iul-agent-commission-explained/) for selling the policy in the first place.\n\nEnter your premium, death benefit, and the cap and participation rate you were quoted. The calculator's year-by-year projection table shows the cash value, surrender value, and death benefit through the age you choose. Alongside it, the calculator puts the same premium into a 401(k) or a taxable brokerage account, letting you see both paths at once.\n\nThe calculator is free to use, with no signup and no Excel file to download. As you change the premium, cap, participation rate, or cost-of-insurance inputs, the table updates using the numbers you enter rather than one carrier's hard-coded rates.\n\nUsing the numbers loaded above, a 40-year-old who pays $12,000 a year for 20 years into a $500,000 policy reaches a surrender value of $583,785 at age 70. With no cap, the same policy would have reached $1,277,172. The cap cost $693,386, while the cost of insurance took another $49,109.",
    howItWorks:
  ...
  // Competitor-monitor pass (2026-09-07): present-value needs-based life insurance calculator --
  // most free "how much life insurance" tools use a flat income multiple; this one discounts the
  // income-replacement years at a stated real rate and nets out debt, final expenses, an education
  // fund, existing coverage, and liquid savings.
  {
    id: "life-insurance-needs",
    updated: "2026-09-07",
    islandId: "life-insurance-needs",
    label: "Life Insurance Needs",
    navOrder: 35,
    metaTitle: "Life Insurance Needs Calculator: How Much You Need",
    metaDescription:
      "Use our free life insurance needs calculator to find your target coverage using present-value income replacement, debts, education costs, and assets.",
    targetKeyword: "life insurance needs calculator",
    h1: "Life Insurance Needs Calculator",
    introText:
      "A life insurance needs calculator determines the exact financial death benefit required to protect your family if you pass away unexpectedly. At ModernWallet, we build our calculators to show the direct mathematical cost of financial decisions, replacing generic rules of thumb with present-value calculations. For example, if you earn $70,000 a year and need 15 years of income replacement, carry $10,000 in other debt, owe $250,000 on a mortgage, budget $15,000 for final expenses, and allocate $60,000 for a child's education fund, your total obligations reach $1,170,655 when your income stream is discounted at a 3% real rate. That total reflects an $835,655 present-value income replacement sum added to $335,000 in immediate liabilities. Subtracting $50,000 in existing life insurance and $30,000 in liquid savings leaves a recommended coverage target of $1,090,655.\n\nLife insurance functions as a risk contract where you pay regular premiums to an insurance company in exchange for a guaranteed tax-free lump-sum payment to your designated beneficiaries upon your death. Traditional financial advice often tells buyers to multiply their annual salary by 10, but that shortcut fails to account for varying mortgage balances, existing savings accounts, child care expenses, or the interest that a payout earns when invested. This calculator isolates each debt, education goal, and income need individually so you purchase the exact policy size your household requires.",
    howItWorks:
      "This life insurance needs calculator computes your recommended coverage with an arithmetic formula that balances long-term income replacement against existing assets: recommended coverage equals the present value of income replacement plus total obligations minus total resources, floored at zero. The core engine of this calculation is the present value of an annuity formula: annual income multiplied by ((1 - (1 + 0.03)^-years) / 0.03). Rather than multiplying annual income by the number of years your family needs support, the tool applies a 3% real, inflation-adjusted discount rate. A family that receives a death benefit does not leave the entire sum in a checking account. They invest the proceeds in conservative, interest-bearing assets to generate income. Because the remaining principal continues to earn returns between annual distributions, an initial lump sum of $835,655 invested at a real 3% rate can fully distribute $70,000 per year for 15 years. Using an undiscounted multiple would suggest buying $1,050,000 in coverage for that same income stream, causing you to pay premiums on over $214,000 of unnecessary insurance.\n\nThe obligations component totals four distinct financial liabilities that your policy should cover: non-mortgage debt, mortgage principal, final expenses, and future education costs. Non-mortgage debt includes credit card balances, vehicle loans, personal loans, and student debt that would burden surviving family members. The remaining mortgage balance accounts for your primary residence so a surviving partner can eliminate monthly housing payments or maintain family stability without moving. Final expenses represent immediate settlement outlays such as funeral services, burial or cremation, medical copays, and administrative probate costs, which typically require $10,000 to $20,000 in immediate cash. If you only need minimal coverage to resolve burial bills and end-of-life accounts, read our guide on [final expense insurance vs. whole life insurance](/compare/final-expense-insurance-vs-whole-life-insurance/) to compare dedicated small-face-amount policies. The education fund allows parents to set aside dedicated capital for college tuition, trade school, or living stipends for each dependent child.\n\nThe resources component sums the financial reserves your household already possesses to offset those obligations, including existing life insurance policies in force and liquid cash, high-yield savings, or taxable investments. Subtracting these available assets produces your net coverage amount. This dollar target applies regardless of whether you choose term life insurance or permanent coverage. Term insurance provides a level death benefit over a fixed timeline such as 10, 20, or 30 years and carries low premiums because it expires without cash value. Permanent policies, including whole and universal life, provide lifetime coverage with a cash-value savings component at much higher premium rates. You can review our comparison of [term life vs. universal life insurance](/compare/term-life-vs-universal-life-insurance/) to determine which structure matches your timeline. When shopping for coverage, premiums depend on your current age, medical underwriting history, lifestyle factors, policy face value, and term duration. Rather than relying on captive agents from a single company, comparing quotes through an independent insurance broker ensures you secure competitive rates from multiple licensed carriers for your calculated coverage target. Enter your household numbers into our life insurance needs calculator above to find your target coverage and begin comparing policy options.",
    faqs: [
      { question: "How much life insurance do I actually need?", answer: "You need enough life insurance to replace your earned income for the years your dependents rely on you, pay off shared household debts, clear the mortgage, and fund major future expenses like education, minus any liquid assets you already own. That total is different for every household: a working parent with a large mortgage and young children needs far more coverage than a debt-free household with grown kids and a large savings balance. Enter your own income, debt, and asset numbers into the calculator above rather than relying on a generic multiple of your salary. Calculating your specific liabilities keeps you from paying premiums on excess coverage or leaving your dependents exposed to a real shortfall." },
      { question: "Is a flat 10x your income rule good enough?", answer: "A flat 10x income rule is not reliable because it fails to account for household debt levels, family size, existing savings, or the investment growth of the death benefit. Two individuals each earning $100,000 have completely different life insurance needs if one person is single with no debt and the other has a $400,000 mortgage, three young children, and zero savings. A simple multiple treats both situations identically, leaving the family with debt underinsured while recommending an unnecessarily large policy for the debt-free worker. Furthermore, multiplying salary by ten ignores the fact that a beneficiary can invest a lump-sum death benefit, generating real interest returns that help fund yearly living expenses over time. Calculating individual liabilities and discounting income replacement produces a coverage target that reflects real household economics." },
      { question: "What is the difference between term and permanent life insurance for this calculator's purpose?", answer: "This calculator determines the total dollar amount of death benefit your family requires, which remains the same whether you fulfill that need with term life insurance or permanent life insurance. Term life insurance provides pure coverage for a specific number of years, such as 10, 20, or 30 years, and pays out only if you pass away while the policy is active. Because term policies do not build cash value and eventually expire, their premiums are substantially lower than permanent alternatives. Permanent life insurance, including whole life and universal life, covers your entire lifespan as long as premiums are paid and incorporates a tax-deferred cash-value component. Most families purchase term life insurance to cover temporary responsibilities, such as paying off a mortgage or raising children to financial independence. If you want to evaluate permanent policy structures or long-term estate planning, explore our comparison of [term life vs. universal life insurance](/compare/term-life-vs-universal-life-insurance/) alongside our broader [retirement planning guides](/retirement/)." },
      { question: "Do I need life insurance if I have no kids or debt?", answer: "You generally do not need life insurance if you have no children, no financial dependents, and no debts that another person co-signed. The primary purpose of life insurance is replacing economic support that other people depend on to survive. If your death would not cause immediate financial hardship to a spouse, partner, or dependent family member, buying an income-replacement policy wastes money that could otherwise be invested in an emergency fund or retirement portfolio. The main exception applies to individuals who co-signed private student loans or personal debt with parents, where the surviving co-signer would become legally responsible for the balance. Outside of shared legal debts, single adults without dependents typically need only modest liquid savings to settle final medical bills and burial costs." },
      { question: "Why does this calculator use a discount rate instead of just multiplying my income by the years?", answer: "This calculator applies a 3% real discount rate because a beneficiary receives a life insurance payout as an immediate lump sum that can earn investment returns while paying out annual family expenses over time. If you simply multiply an annual income need of $80,000 by 20 years, an undiscounted formula suggests your family requires $1,600,000 in coverage. However, your family will not spend that entire $1,600,000 on day one. By depositing the payout into conservative, interest-bearing assets that earn a modest 3% return above the rate of inflation, the remaining balance continues to grow between annual withdrawals. Under a 3% real discount rate, a starting lump sum of approximately $1,190,000 provides the exact same $80,000 annual purchasing power over 20 years. Accounting for the time value of money prevents you from purchasing hundreds of thousands of dollars in redundant coverage and overpaying on monthly premiums." },
    ],
    defaultPreset: {
      annualIncome: 70000,
      yearsToReplace: 15,
  ...
  // Competitor-monitor pass (2026-09-07): operating cash flow (indirect method, FASB ASC 230) --
  // built for the business-financing vertical so an SMB owner can check their own cash-flow
  // health before shopping for a loan or line of credit.
  {
    id: "operating-cash-flow",
    updated: "2026-09-07",
    islandId: "operating-cash-flow",
    label: "Operating Cash Flow",
    navOrder: 36,
    metaTitle: "Operating Cash Flow Calculator: Cash from Operations",
    metaDescription:
      "Use our free operating cash flow calculator to measure the cash your core business generates using net income, non-cash charges, and working capital changes.",
    targetKeyword: "operating cash flow calculator",
    h1: "Operating Cash Flow Calculator",
    introText:
  ...
  // Competitor-monitor pass (2026-09-07): cash conversion cycle (DIO + DSO - DPO) -- built for
  // the business-financing vertical so an SMB owner can size how much short-term financing their
  // own operating cycle actually needs, rather than guessing.
  {
    id: "cash-conversion-cycle",
    updated: "2026-09-07",
    islandId: "cash-conversion-cycle",
    label: "Cash Conversion Cycle",
    navOrder: 37,
    metaTitle: "Cash Conversion Cycle Calculator: See Your CCC in Days",
    metaDescription:
      "Use this free cash conversion cycle calculator to track how long cash stays tied up in inventory and invoices before returning to your business.",
    targetKeyword: "cash conversion cycle calculator",
    h1: "Cash Conversion Cycle Calculator",
    introText:
      "A cash conversion cycle calculator measures how long operations tie up cash before customer sales return it to your bank account. In our default baseline, a business generates $1,000,000 in annual revenue alongside $600,000 in cost of goods sold (COGS). Carrying $90,000 in average inventory, $110,000 in accounts receivable, and $70,000 in accounts payable produces a cash conversion cycle (CCC) of 52.3 days.\n\nThat result reflects 54.8 days of inventory outstanding (DIO) plus 40.1 days of sales outstanding (DSO), minus 42.6 days of payables outstanding (DPO). At ModernWallet, we build financial tools to help business owners calculate the exact working capital gap their operations create. This gap shows whether cash reserves, a [business line of credit](/business-line-of-credit/), or [invoice factoring](/invoice-factoring/) best covers your ongoing overhead while waiting for collections.",
    howItWorks:
      "The cash conversion cycle formula traces how working capital moves through purchasing, customer billing, and supplier disbursements. The standard equation is CCC = Days Inventory Outstanding (DIO) + Days Sales Outstanding (DSO) - Days Payable Outstanding (DPO). The formula adds the days your cash is locked in inventory and receivables, then subtracts the credit window your suppliers provide.\n\nDays inventory outstanding measures the average number of days goods sit in storage before selling to customers. The formula is DIO = (Average Inventory / COGS) x Period Days. Dividing our default $90,000 inventory by $600,000 in COGS and multiplying by 365 days yields 54.8 days.\n\nDays sales outstanding measures the average number of days your business takes to collect cash payments after completing a sale. The formula is DSO = (Average Accounts Receivable / Revenue) x Period Days. Dividing $110,000 in receivables by $1,000,000 in revenue and multiplying by 365 days yields 40.1 days of uncollected customer invoices.\n\nDays payable outstanding measures the average number of days your company takes to pay suppliers for inventory and trade purchases. The formula is DPO = (Average Accounts Payable / COGS) x Period Days. Dividing $70,000 in payables by $600,000 in COGS and multiplying by 365 days yields 42.6 days of trade credit.\n\nAll calculations require figures from the exact same accounting period to produce accurate results. You can evaluate an entire year using 365 days, or examine an individual quarter by entering 90 days alongside quarterly financial statement numbers. Using an annual revenue figure with quarterly inventory balances distorts your cycle and produces misleading metrics.\n\nA positive cash conversion cycle indicates the precise working capital gap your business must sustain between outgoing and incoming cash flows. In our 52.3-day example, your company must fund payroll, rent, and operating overhead for over seven weeks before sales revenue replenishes your account. Companies frequently bridge this timing gap by drawing on a revolving [business line of credit](/business-line-of-credit/) or by selling unpaid invoices through [invoice factoring](/invoice-factoring/).\n\nWhen unexpected inventory purchases outpace established credit limits, some business owners turn toward a [merchant cash advance](/merchant-cash-advance/) to access rapid capital. However, evaluating your cash conversion cycle alongside your broader [operating cash flow](/operating-cash-flow/) indicates whether your operational margins can cover this timing gap organically. Generating strong operating cash flow allows your company to self-fund working capital needs instead of taking on recurring borrowing costs.\n\nA negative cash conversion cycle occurs when days payable outstanding exceed the sum of inventory days and receivable days combined. If a merchant sells through inventory in 10 days and collects card receipts in 2 days while maintaining 45-day supplier payment terms, the resulting cycle is -33 days. That business collects cash from customers 33 days before paying its suppliers, so trade credit finances daily operations.\n\nTo see how operational adjustments release cash, consider the concrete impact of reducing collection times in our default baseline. If you shorten customer collection times by 10 days, DSO drops from 40.1 days to 30.1 days, reducing your total cycle from 52.3 days to 42.3 days. At $1,000,000 in annual revenue, each collection day represents roughly $2,740 in sales, so a 10-day DSO reduction releases over $27,000 in immediate cash into your bank account.\n\nYou can also reduce your cycle through better inventory turnover or extended supplier credit windows. Trimming slow-moving inventory reduces storage expenses and lowers DIO, while negotiating supplier terms from net-30 to net-45 increases DPO and preserves cash balances. Achieving small gains across all three operational levers compounds to release substantial liquidity and reduce reliance on outside debt.",
    faqs: [
      { question: "What is the cash conversion cycle?", answer: "The cash conversion cycle measures the days between spending cash on inventory and collecting cash from customer sales, net of supplier payment terms. It evaluates operational efficiency across inventory management, customer billing, and trade credit terms. A lower cycle means working capital moves rapidly through your business, keeping liquidity available for payroll and operating overhead.\n\nWhen this metric increases over consecutive quarters, cash is getting delayed in your daily operations. Unsold stock accumulating in warehouses or delinquent customer invoices are the standard causes of an expanding cycle. Monitoring this figure quarterly helps you spot working capital bottlenecks before they cause a severe cash crunch." },
      { question: "What is a negative cash conversion cycle and is it good?", answer: "A negative cash conversion cycle occurs when your days payable outstanding exceed the combined total of your inventory and collection days. In this scenario, your business collects cash from customer sales before you are required to pay your suppliers for that inventory. This setup is advantageous because suppliers effectively finance your everyday operations at zero interest.\n\nRetail grocers and direct-to-consumer e-commerce brands frequently maintain negative cycles through rapid inventory turnover and instant card payments. However, operating with a negative cycle requires predictable sales demand and disciplined cash management. If customer sales drop unexpectedly, you must still pay your supplier invoices on schedule." },
      { question: "How do I lower my cash conversion cycle?", answer: "You lower your cash conversion cycle by reducing inventory holding periods, collecting customer receivables faster, or extending payment terms with your suppliers. Order stock in smaller batches and clear out slow-moving items with promotional pricing to lower days inventory outstanding. To accelerate customer collections, invoice immediately upon delivery, set firm credit terms, and offer early-payment discounts.\n\nTo increase days payable outstanding, negotiate with suppliers for 45-day or 60-day payment terms instead of standard 30-day windows. However, avoid delaying supplier payments if doing so forfeits early-payment discounts that exceed the interest rate of outside financing. Balancing all three levers keeps cash circulating through your operations rather than sitting idle on your balance sheet." },
      { question: "What is a good cash conversion cycle number?", answer: "A good cash conversion cycle depends on your industry, business model, and operational scale. No universal benchmark fits all companies. Service companies with zero physical inventory and immediate credit card billing often maintain cycles below 15 days. Conversely, equipment manufacturers that purchase raw materials and extend net-60 commercial credit routinely operate with cycles exceeding 90 days.\n\nRather than measuring your company against outside industry averages, compare your cycle against your own historical quarterly performance. A cycle that shortens over time demonstrates improving operational control and stronger liquidity. A steadily lengthening cycle indicates that cash is getting trapped in unsold inventory or overdue customer receivables." },
      { question: "How does the cash conversion cycle relate to needing a business loan or line of credit?", answer: "The cash conversion cycle reveals the exact calendar duration where your company must finance its operating costs before customer payments arrive. A 52-day cycle means you must cover payroll, facility leases, and utility bills for nearly two months before sales receipts replenish your accounts. That timing difference is the specific operational gap that short-term commercial financing is designed to bridge.\n\nKnowing your cycle duration prevents you from guessing how much borrowing capacity your business actually requires. Companies with long inventory holding periods often draw on a revolving [business line of credit](/business-line-of-credit/) to purchase seasonal stock, while businesses facing delayed customer payments turn to [invoice factoring](/invoice-factoring/) to advance cash against open invoices. Before considering higher-cost borrowing options like a [merchant cash advance](/merchant-cash-advance/), check your [operating cash flow](/operating-cash-flow/) to confirm whether operational margins can bridge the gap sustainably." },
    ],
    defaultPreset: {
      cogs: 600000,
