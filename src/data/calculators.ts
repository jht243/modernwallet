...
export const CALCULATORS: CalculatorDef[] = [
  ...
  // Engine: src/lib/estate-planning-hub.ts. Island: EstatePlanningHubCalculator.
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "The most common estate planning mistake is a stale beneficiary designation. A 401(k), IRA, or life insurance beneficiary form overrides even a freshly signed will, so an ex-spouse or a deceased parent still listed there gets the money regardless of what the will says. Other frequent mistakes: signing a revocable living trust but never actually retitling assets into it, which leaves the trust empty and forces probate anyway; skipping a guardian nomination for minor children, which lets a court decide instead; and treating a will drafted for one state as good everywhere, when signing and witnessing rules, and any state estate tax, differ by state. See our [living trust cost calculator](/estate-planning/living-trust-cost-calculator/) for the funding checklist that catches the empty-trust mistake specifically.",
      },
    ],
    sources: [
...

  {
    ...
    faqs: [
      ...
      { question: "Does an adopted child qualify for a Trump Account the same as a biological child?", answer: "The law's eligibility test runs on citizenship, birth year, and having a Social Security number, not on how the child came into the family, so an adopted child who is a U.S. citizen born between 2025 and 2028 with an SSN qualifies the same way a biological child does. Adoptions finalized after that birth-year window can raise timing questions the [IRS's Trump Accounts page](https://www.irs.gov/trumpaccounts) is the place to confirm before assuming either way." },
    ],
    sources: [
