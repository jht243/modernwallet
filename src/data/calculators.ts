...
export const CALCULATORS: CalculatorDef[] = [
  {
    ...
    label: "Auto Loan",
    navOrder: 1,
    metaTitle: "Auto Loan Calculator: Estimate Your Car Payment",
    metaDescription:
      "Use our free auto loan calculator to estimate your monthly car payment, total interest, and the true cost of financing a vehicle in 2026.",
...

  {
    ...
    label: "Mortgage",
    navOrder: 2,
    metaTitle: "Mortgage Calculator: Estimate Your Monthly Payment",
    metaDescription:
      "Use our free mortgage calculator to estimate your monthly principal and interest payment, see your full amortization, and learn how a home loan really works.",
...

  {
    ...
    faqs: [
      ...
      { question: "What if I withdraw from my 401(k) early?", answer: "Early 401(k) withdrawals before age 59½ usually trigger a 10% IRS penalty plus income tax. This shrinks your retirement balance and its future growth. Estimate the cost first with our [401k early withdrawal calculator](/retirement/401k-early-withdrawal-calculator/)." },
    ],
    sources: [
