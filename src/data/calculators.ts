...
export const CALCULATORS: CalculatorDef[] = [
...

  {
    ...
    navOrder: 15,
    updated: "2026-09-09",
    metaTitle: "Coast FIRE Calculator: Find Your Coast FI Number",
    metaDescription:
      "Free Coast FIRE calculator, also called Coast FI: see if your savings alone will grow into your full retirement number, and when you'd reach it.",
    ...
    faqs: [
      ...
      { question: "Do my HSA and my emergency fund count toward the \"current retirement savings\" field?", answer: "An emergency fund does not count toward this field, and a health savings account (HSA) belongs only if the balance is invested for retirement. This calculator projects liquid, invested assets compounding at a market return. An emergency fund is held in cash so it can be spent at short notice, and cash does not compound at a market return. Counting it makes you look closer to coasting than you are, and it quietly assumes you would liquidate the cushion to fund retirement.\n\nAn HSA counts only to the extent it is invested rather than sitting in the account's cash sweep. You must also plan to leave those investments untouched, because balances spent on current medical bills cannot compound toward retirement. Money you plan to spend before retirement does not belong in this field." },
    ],
    sources: [
  ...
  // (87.48g gold or 612.36g silver), the way it's actually meant to work.
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Nisab is the minimum amount of wealth a Muslim must hold before zakat becomes due, defined as a weight of gold or silver rather than a fixed dollar figure. The most commonly used modern conversion sets it at 87.48 grams of gold or 612.36 grams of silver, though the [Zakat Foundation of America](https://www.zakat.org/what-is-ni-ab-in-islam) cites a slightly different classical gold conversion of roughly 85 grams. Because the dollar value of either standard moves with the metal's live price, the calculator above asks for today's price rather than assuming a fixed number. Which standard applies to you, and how jewelry and retirement accounts factor in, depends on your school of thought — see our [zakat calculation by madhab](/guides/zakat-calculation-by-madhab-hanafi-shafii-shia/) guide for the Hanafi, Shafi'i, Maliki, Hanbali, and Ja'fari differences.",
      },
      {
        question: "What assets are subject to zakat?",
        answer:
          "Cash and bank balances, gold and silver held as savings or investment, stocks and other investments, business inventory, and money owed to you that you genuinely expect to collect are all zakatable. A home you live in, a car you use personally, and everyday personal-use items are generally excluded, since zakat targets wealth that's productive or held as savings rather than property in active personal use. If you hold cryptocurrency, see our guide on [zakat on cryptocurrency](/guides/zakat-on-cryptocurrency-calculator-explained/) for how digital assets are classified and valued.",
      },
      {
        question: "How do I calculate zakat the right way?",
        answer:
          "Add up your zakatable assets, cash, gold, silver, investments, and money owed to you, then subtract debts and bills due now to get your net zakatable wealth. Compare that figure to the nisab threshold for the metal standard you're using. If your wealth meets or exceeds nisab and you've held it for a full lunar year, multiply the entire zakatable wealth by 2.5% to get the zakat due. Use the full figure here. The amount above nisab alone is a common calculation mistake. If you live under a state-administered system such as Malaysia's, see our [zakat calculator Malaysia by state](/guides/zakat-calculator-malaysia-by-state/) guide for how official collection and tax-rebate rules differ from this general calculation.",
      },
      {
  ...
  // fund, existing coverage, and liquid savings.
  {
    ...
    navOrder: 35,
    metaTitle: "Life Insurance Needs Calculator: Find Your Coverage",
    metaDescription:
      "Use our life insurance needs calculator to find your coverage amount using present-value income replacement, debt balances, and existing household savings.",
  ...
  // own operating cycle actually needs, rather than guessing.
  {
    ...
    navOrder: 37,
    metaTitle: "Cash Conversion Cycle Calculator: Measure Your Cash Gap",
    metaDescription:
      "Use this cash conversion cycle calculator to find how long cash stays tied up in inventory and receivables, and plan working capital financing.",
