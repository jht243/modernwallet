...
export const BUSINESS_FINANCING_SPOKES: SpokeEntry[] = [
  {
    ...
    introText:
      "This factor rate calculator converts a merchant cash advance factor rate into the actual dollars you'll repay and shows the effective APR behind it.\n\nA factor rate is a decimal, such as 1.4. Multiply it by your advance to calculate your total payback. Because it is not an interest rate, it hides the true yearly cost. Enter your advance amount, factor rate, and term below to see what the deal actually costs.\n\nThis tool is part of our [merchant cash advance hub](/merchant-cash-advance/). To compare the same offer with a bank loan, try our [merchant cash advance payoff calculator](/merchant-cash-advance/merchant-cash-advance-payoff-calculator/).",
    howItWorks:
  ...
  },
  {
    ...
    introText:
      "Use this merchant cash advance payoff calculator to see your total payoff amount, daily payment, and whether paying early saves you anything.\n\nUnlike a normal loan, a merchant cash advance payoff is based on the factor rate, not remaining interest. Enter your advance, factor rate, and term below to see the full balance you owe and how quickly daily payments reduce it.\n\nThis tool is part of our [merchant cash advance hub](/merchant-cash-advance/). To convert a raw factor rate to an APR, use our [factor rate calculator](/merchant-cash-advance/factor-rate-calculator/).",
    howItWorks:
  ...
  },
  {
    ...
    introText:
      "Use this accounts receivable financing calculator to see how much cash you get today, what you pay in fees, and the real effective APR on an invoice.\n\nAccounts receivable financing lets a business turn unpaid invoices into immediate cash by advancing most of the invoice value now. Enter your invoice amount, advance rate, factor fee, and expected days until payment below. The calculator will show your advance, reserve, and net proceeds.\n\nThis tool is part of our [invoice factoring hub](/invoice-factoring/). To calculate the fee alone on a single invoice, use our [factoring fee calculator](/invoice-factoring/factoring-fee-calculator/). After you've run the numbers, read our guide on [how to account for invoice factoring](/guides/how-to-account-for-invoice-factoring/) for the GAAP journal entries behind the advance, reserve, and rebate shown here.",
    howItWorks:
  ...
  },
  {
    ...
    introText:
      "Use this factoring fee calculator to see the exact fee, cash advance, and effective APR for a single invoice.\n\nA factoring fee is the discount a factor keeps in exchange for advancing cash against your invoice before your customer pays. Enter your invoice amount, advance rate, factor fee, and days until payment below to calculate your advance, reserve, rebate, and net proceeds in seconds.\n\nYou'll find this tool in our [invoice factoring hub](/invoice-factoring/). To model an ongoing financing arrangement rather than a single invoice, use our [accounts receivable financing calculator](/invoice-factoring/accounts-receivable-financing/).",
    howItWorks:
