...
export const ESTATE_PLANNING_SPOKES: SpokeEntry[] = [
...

  {
    ...
    commonMistakes: [
      ...
      "Not updating beneficiary designations. 401(k), IRA, and life-insurance beneficiary forms override BOTH your will and your trust. Retitling accounts into the trust isn't enough — update the beneficiary form too. See our guide on [401(k) beneficiary rules](/guides/401k-beneficiary-rules/) for the spouse vs. non-spouse rules and how inherited balances are taxed.",
    ],
    workedExample:
